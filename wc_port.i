# 1 "wolfcrypt/src/wc_port.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/wc_port.c"
# 24 "wolfcrypt/src/wc_port.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/wc_port.c" 2
...
int wolfCrypt_Init(void)
{
    ...
    if (initRefCount == 0) {
        ;
# 287 "wolfcrypt/src/wc_port.c"
    }
    initRefCount++;

    return ret;
}
# 308 "wolfcrypt/src/wc_port.c"
    ...
    void* heap)
{
    ...
    if (fname == 
# 374 "wolfcrypt/src/wc_port.c" 3 4
                ((void *)0) 
# 374 "wolfcrypt/src/wc_port.c"
                     || buf == 
# 374 "wolfcrypt/src/wc_port.c" 3 4
                               ((void *)0) 
# 374 "wolfcrypt/src/wc_port.c"
...
# 374 "wolfcrypt/src/wc_port.c"
    ...
    *buf = 
# 379 "wolfcrypt/src/wc_port.c" 3 4
          ((void *)0)
# 379 "wolfcrypt/src/wc_port.c"
              ;
    *bufLen = 0;
    ...
    fseek(f, 0, 
# 389 "wolfcrypt/src/wc_port.c" 3
                2
# 389 "wolfcrypt/src/wc_port.c"
                         );
    fileSz = ftell(f);
    rewind(f);
    if (fileSz > 0) {
        *bufLen = fileSz;
        *buf = (byte*)wolfSSL_Malloc((*bufLen), (heap), (DYNAMIC_TYPE_TMP_BUFFER));
        if (*buf == 
# 395 "wolfcrypt/src/wc_port.c" 3 4
                   ((void *)0)
# 395 "wolfcrypt/src/wc_port.c"
                       ) {
            ;
            ret = MEMORY_E;
        }
...
int wc_ReadDirFirst(ReadDirCtx* ctx, const char* path, char** name)
{
    ...
    if (name)
        *name = 
# 428 "wolfcrypt/src/wc_port.c" 3 4
               ((void *)0)
# 428 "wolfcrypt/src/wc_port.c"
                   ;

    if (ctx == 
# 430 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0) 
# 430 "wolfcrypt/src/wc_port.c"
                   || path == 
# 430 "wolfcrypt/src/wc_port.c" 3 4
                              ((void *)0)
# 430 "wolfcrypt/src/wc_port.c"
    ...
    memset((ctx->name),(0),(256));
    pathLen = (int)strlen((path));
# 532 "wolfcrypt/src/wc_port.c"
    ctx->dir = opendir(path);
    if (ctx->dir == 
# 533 "wolfcrypt/src/wc_port.c" 3 4
                   ((void *)0)
# 533 "wolfcrypt/src/wc_port.c"
                       ) {
        ;
        return BAD_PATH_ERROR;
    }
...
# 538 "wolfcrypt/src/wc_port.c" 3 4
                                              ((void *)0)
# 538 "wolfcrypt/src/wc_port.c"
                                                  ) {
        dnameLen = (int)strlen((ctx->entry->d_name));

        if (pathLen + dnameLen + 2 >= 256) {
            ret = BAD_PATH_ERROR;
            break;
        }
        strncpy((ctx->name),(path),(pathLen + 1));
        ctx->name[pathLen] = '/';




        strncpy((ctx->name + pathLen + 1),(ctx->entry->d_name),(dnameLen + 1));
        if (stat(ctx->name, &ctx->s) != 0) {
            ;
            ret = BAD_PATH_ERROR;
            break;
        } else if (
# 556 "wolfcrypt/src/wc_port.c" 3
                  ((((
# 556 "wolfcrypt/src/wc_port.c"
                  ctx->s.st_mode
# 556 "wolfcrypt/src/wc_port.c" 3
                  )) & 0170000) == (0100000))
# 556 "wolfcrypt/src/wc_port.c"
...
int wc_ReadDirNext(ReadDirCtx* ctx, const char* path, char** name)
{
    ...
    if (name)
        *name = 
# 576 "wolfcrypt/src/wc_port.c" 3 4
               ((void *)0)
# 576 "wolfcrypt/src/wc_port.c"
                   ;

    if (ctx == 
# 578 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0) 
# 578 "wolfcrypt/src/wc_port.c"
                   || path == 
# 578 "wolfcrypt/src/wc_port.c" 3 4
                              ((void *)0)
# 578 "wolfcrypt/src/wc_port.c"
    ...
    memset((ctx->name),(0),(256));
    pathLen = (int)strlen((path));
# 656 "wolfcrypt/src/wc_port.c"
    while ((ctx->entry = readdir(ctx->dir)) != 
# 656 "wolfcrypt/src/wc_port.c" 3 4
                                              ((void *)0)
# 656 "wolfcrypt/src/wc_port.c"
                                                  ) {
        dnameLen = (int)strlen((ctx->entry->d_name));
...
# 674 "wolfcrypt/src/wc_port.c" 3
                  ((((
# 674 "wolfcrypt/src/wc_port.c"
                  ctx->s.st_mode
# 674 "wolfcrypt/src/wc_port.c" 3
                  )) & 0170000) == (0100000))
# 674 "wolfcrypt/src/wc_port.c"
...
{
    if (ctx == 
# 689 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0)
# 689 "wolfcrypt/src/wc_port.c"
                  ) {
        return;
    }
# 709 "wolfcrypt/src/wc_port.c"
    if (ctx->dir) {
        closedir(ctx->dir);
        ctx->dir = 
# 711 "wolfcrypt/src/wc_port.c" 3 4
                  ((void *)0)
# 711 "wolfcrypt/src/wc_port.c"
                      ;
    }

}
# 751 "wolfcrypt/src/wc_port.c"
wolfSSL_Mutex* wc_InitAndAllocMutex(void)
{
    wolfSSL_Mutex* m = (wolfSSL_Mutex*) wolfSSL_Malloc((sizeof(wolfSSL_Mutex)), (
# 753 "wolfcrypt/src/wc_port.c" 3 4
                                       ((void *)0)
# 753 "wolfcrypt/src/wc_port.c"
                                       ), (DYNAMIC_TYPE_MUTEX))
                               ;
    if (m != 
# 755 "wolfcrypt/src/wc_port.c" 3 4
            ((void *)0)
# 755 "wolfcrypt/src/wc_port.c"
                ) {
        if (wc_InitMutex(m) != 0) {
            ;
            {void* xp = (m); if((xp)) wolfSSL_Free((xp), (
# 758 "wolfcrypt/src/wc_port.c" 3 4
           ((void *)0)
# 758 "wolfcrypt/src/wc_port.c"
           ), (DYNAMIC_TYPE_MUTEX));};
            m = 
# 759 "wolfcrypt/src/wc_port.c" 3 4
               ((void *)0)
# 759 "wolfcrypt/src/wc_port.c"
                   ;
        }
    }
    else {
...
char* wc_strtok(char *str, const char *delim, char **nextp)
{
    ...
    if (str == 
# 778 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0) 
# 778 "wolfcrypt/src/wc_port.c"
                   && nextp)
        str = *nextp;


    if (str == 
# 782 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0) 
# 782 "wolfcrypt/src/wc_port.c"
                   || *str == '\0')
        return 
# 783 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0)
# 783 "wolfcrypt/src/wc_port.c"
                  ;
    ...
    if (*str == '\0')
        return 
# 797 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0)
# 797 "wolfcrypt/src/wc_port.c"
                  ;
...
char* wc_strsep(char **stringp, const char *delim)
{
    ...
    if (stringp == 
# 831 "wolfcrypt/src/wc_port.c" 3 4
                  ((void *)0) 
# 831 "wolfcrypt/src/wc_port.c"
                       || *stringp == 
# 831 "wolfcrypt/src/wc_port.c" 3 4
                                      ((void *)0)
# 831 "wolfcrypt/src/wc_port.c"
        ...
        return 
# 832 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0)
# 832 "wolfcrypt/src/wc_port.c"
                  ;
    ...
    *stringp = 
# 846 "wolfcrypt/src/wc_port.c" 3 4
              ((void *)0)
# 846 "wolfcrypt/src/wc_port.c"
                  ;
    return s;
}
# 1082 "wolfcrypt/src/wc_port.c"
...
# 2389 "wolfcrypt/src/wc_port.c"
char* mystrnstr(const char* s1, const char* s2, unsigned int n)
{
    unsigned int s2_len = (unsigned int)strlen((s2));
    ...
    return 
# 2404 "wolfcrypt/src/wc_port.c" 3 4
          ((void *)0)
# 2404 "wolfcrypt/src/wc_port.c"
              ;
}
