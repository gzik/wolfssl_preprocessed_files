...
# 1 "./config.h" 1
# 25 "wolfcrypt/src/wc_encrypt.c" 2
...
# 28 "wolfcrypt/src/wc_encrypt.c" 2
# 1 "./wolfssl/wolfcrypt/aes.h" 1
# 37 "./wolfssl/wolfcrypt/aes.h"
...
# 29 "wolfcrypt/src/wc_encrypt.c" 2
# 1 "./wolfssl/wolfcrypt/des3.h" 1
# 30 "wolfcrypt/src/wc_encrypt.c" 2
...
# 31 "wolfcrypt/src/wc_encrypt.c" 2
# 1 "./wolfssl/wolfcrypt/rc2.h" 1
# 32 "wolfcrypt/src/wc_encrypt.c" 2
...
__attribute__ ((visibility("default"))) int wc_Arc4Process(Arc4*, byte*, const byte*, word32);
__attribute__ ((visibility("default"))) int wc_Arc4SetKey(Arc4*, const byte*, word32);

__attribute__ ((visibility("default"))) int wc_Arc4Init(Arc4*, void*, int);
__attribute__ ((visibility("default"))) void wc_Arc4Free(Arc4*);
# 33 "wolfcrypt/src/wc_encrypt.c" 2
# 1 "./wolfssl/wolfcrypt/wc_encrypt.h" 1
# 34 "wolfcrypt/src/wc_encrypt.c" 2
...
# 35 "wolfcrypt/src/wc_encrypt.c" 2
...
# 36 "wolfcrypt/src/wc_encrypt.c" 2
...
__attribute__ ((visibility("default"))) int Base64_Decode(const byte* in, word32 inLen, byte* out,
                               word32* outLen);
# 37 "wolfcrypt/src/wc_encrypt.c" 2
# 1 "./wolfssl/wolfcrypt/pwdbased.h" 1
# 38 "wolfcrypt/src/wc_encrypt.c" 2
...
# 39 "wolfcrypt/src/wc_encrypt.c" 2
...
# 45 "wolfcrypt/src/wc_encrypt.c" 2
