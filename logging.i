# 1 "wolfcrypt/src/logging.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/logging.c"
# 24 "wolfcrypt/src/logging.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/logging.c" 2
...
# 31 "wolfcrypt/src/logging.c" 2
# 116 "wolfcrypt/src/logging.c"
const char *wolfSSL_configure_args(void) {


  return " " " '--host=aarch64' '--enable-cryptonly' '--enable-sp=small,nomalloc,384' '--enable-sp-math' '--enable-sp-asm' '--enable-ecc' '--enable-cmac' '--enable-aesgcm' '--disable-aescbc' '--disable-rsa' '--disable-dh' '--disable-sha' '--disable-hkdf' '--disable-tls13' '--disable-md5' '--disable-sha224' '--disable-sha512' '--disable-sha3' '--disable-chacha' '--disable-poly1305' 'CFLAGS=-save-temps -DNO_SHA -DNO_ECC256 -DWOLFSSL_SP_NO_256 -DNO_ECC_KEY_EXPORT -DNO_PKCS8 -DNO_ASN_TIME -DNO_CERTS -DWOLFSSL_STATIC_MEMORY -DWOLFSSL_SP_NO_MALLOC -Wimplicit-fallthrough=0' 'host_alias=aarch64' 'CC=aarch64-linux-gnu-gcc'" " ";
...
const char *wolfSSL_global_cflags(void) {
  ...
  return " " "  -save-temps -DNO_SHA -DNO_ECC256 -DWOLFSSL_SP_NO_256 -DNO_ECC_KEY_EXPORT -DNO_PKCS8 -DNO_ASN_TIME -DNO_CERTS -DWOLFSSL_STATIC_MEMORY -DWOLFSSL_SP_NO_MALLOC -Wimplicit-fallthrough=0   -Werror -Wno-pragmas -Wall -Wno-strict-aliasing -Wextra -Wunknown-pragmas --param=ssp-buffer-size=1 -Waddress -Warray-bounds -Wbad-function-cast -Wchar-subscripts -Wcomment -Wfloat-equal -Wformat-security -Wformat=2 -Wmaybe-uninitialized -Wmissing-field-initializers -Wmissing-noreturn -Wmissing-prototypes -Wnested-externs -Wnormalized=id -Woverride-init -Wpointer-arith -Wpointer-sign -Wredundant-decls -Wshadow -Wsign-compare -Wstrict-overflow=1 -Wswitch-enum -Wundef -Wunused -Wunused-result -Wunused-variable -Wwrite-strings -fwrapv -D_POSIX_THREADS  -fvisibility=hidden -DHAVE_THREAD_LS -DNDEBUG -pthread -DTFM_TIMING_RESISTANT -DECC_TIMING_RESISTANT -DWC_RSA_BLINDING -DNO_AES_CBC -DWOLFSSL_SHA384 -DNO_DSA -DHAVE_ECC -DTFM_ECC256 -DECC_SHAMIR -DNO_RSA -DNO_DH -DNO_RC4 -DNO_MD5 -DNO_OLD_TLS -DNO_SHA -DNO_OLD_TLS -DWOLFSSL_CMAC -DWOLFSSL_AES_DIRECT -DNO_HC128 -DNO_RABBIT -DHAVE_HASHDRBG -DHAVE_TLS_EXTENSIONS -DHAVE_SUPPORTED_CURVES -DHAVE_EXTENDED_MASTER -DNO_RC4 -DHAVE_ENCRYPT_THEN_MAC -DNO_PSK -DNO_MD4 -DNO_PWDBASED -DWOLFCRYPT_ONLY -DWOLFSSL_HAVE_SP_ECC -DHAVE_ECC384 -DWOLFSSL_SP_384 -DWOLFSSL_SP_SMALL -DWOLFSSL_SP_NO_MALLOC -DWOLFSSL_SP_ASM -DWOLFSSL_SP_ARM64_ASM -DWOLFSSL_SP_MATH -DWC_NO_ASYNC_THREADING -DHAVE_DH_DEFAULT_PARAMS -DNO_DES3 -DGCM_TABLE_4BIT -DHAVE_AESGCM -Wall -Wno-unused -Os -DHAVE___UINT128_T=1 -DHAVE_WC_INTROSPECTION" " ";



}
# 161 "wolfcrypt/src/logging.c"
...
wolfSSL_Logging_cb wolfSSL_GetLoggingCb(void)
{
    ...
    return 
# 178 "wolfcrypt/src/logging.c" 3 4
          ((void *)0)
# 178 "wolfcrypt/src/logging.c"
              ;
