# 1 "wolfcrypt/src/signature.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/signature.c"
# 24 "wolfcrypt/src/signature.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/signature.c" 2
...
# 28 "wolfcrypt/src/signature.c" 2
# 1 "./wolfssl/wolfcrypt/signature.h" 1
# 30 "./wolfssl/wolfcrypt/signature.h"
...
# 31 "./wolfssl/wolfcrypt/signature.h" 2
...
# 241 "./wolfssl/wolfcrypt/random.h"
    ...
    __attribute__ ((visibility("default"))) int wc_RNG_HealthTest_ex(int reseed,
                                        ...
                                        byte* output, word32 outputSz,
                                        void* heap, int devId);
# 33 "./wolfssl/wolfcrypt/signature.h" 2
...
__attribute__ ((visibility("default"))) int wc_SignatureGetSize(enum wc_SignatureType sig_type,
    const void* key, word32 key_len);

__attribute__ ((visibility("default"))) int wc_SignatureVerifyHash(
    enum wc_HashType hash_type, enum wc_SignatureType sig_type,
    const byte* hash_data, word32 hash_len,
    const byte* sig, word32 sig_len,
    const void* key, word32 key_len);

__attribute__ ((visibility("default"))) int wc_SignatureVerify(
    enum wc_HashType hash_type, enum wc_SignatureType sig_type,
    const byte* data, word32 data_len,
    const byte* sig, word32 sig_len,
    const void* key, word32 key_len);

__attribute__ ((visibility("default"))) int wc_SignatureGenerateHash(
    enum wc_HashType hash_type, enum wc_SignatureType sig_type,
    const byte* hash_data, word32 hash_len,
    byte* sig, word32 *sig_len,
    const void* key, word32 key_len, WC_RNG* rng);
__attribute__ ((visibility("default"))) int wc_SignatureGenerateHash_ex(
    enum wc_HashType hash_type, enum wc_SignatureType sig_type,
    const byte* hash_data, word32 hash_len,
    byte* sig, word32 *sig_len,
    const void* key, word32 key_len, WC_RNG* rng, int verify);
__attribute__ ((visibility("default"))) int wc_SignatureGenerate(
    enum wc_HashType hash_type, enum wc_SignatureType sig_type,
    const byte* data, word32 data_len,
    byte* sig, word32 *sig_len,
    const void* key, word32 key_len,
    WC_RNG* rng);
__attribute__ ((visibility("default"))) int wc_SignatureGenerate_ex(
    enum wc_HashType hash_type, enum wc_SignatureType sig_type,
    const byte* data, word32 data_len,
    byte* sig, word32 *sig_len,
    const void* key, word32 key_len,
    WC_RNG* rng, int verify);
# 29 "wolfcrypt/src/signature.c" 2
...
# 30 "wolfcrypt/src/signature.c" 2
...
# 31 "wolfcrypt/src/signature.c" 2
...
# 33 "wolfcrypt/src/signature.c" 2
...
# 36 "wolfcrypt/src/signature.c" 2
# 73 "wolfcrypt/src/signature.c"
    ...
    const void* key, word32 key_len)
{
    ...
    if (hash_data == 
# 129 "wolfcrypt/src/signature.c" 3 4
                    ((void *)0) 
# 129 "wolfcrypt/src/signature.c"
                         || hash_len == 0 ||
        sig == 
# 130 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 130 "wolfcrypt/src/signature.c"
                   || sig_len == 0 ||
        key == 
# 131 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 131 "wolfcrypt/src/signature.c"
                   || key_len == 0) {
        return BAD_FUNC_ARG;
    }
    ...
    const void* key, word32 key_len)
{
    ...
    if (data == 
# 271 "wolfcrypt/src/signature.c" 3 4
               ((void *)0) 
# 271 "wolfcrypt/src/signature.c"
                    || data_len == 0 ||
        sig == 
# 272 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 272 "wolfcrypt/src/signature.c"
                   || sig_len == 0 ||
        key == 
# 273 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 273 "wolfcrypt/src/signature.c"
                   || key_len == 0) {
        return BAD_FUNC_ARG;
    }
    ...
    const void* key, word32 key_len, WC_RNG* rng, int verify)
{
    ...
    if (hash_data == 
# 356 "wolfcrypt/src/signature.c" 3 4
                    ((void *)0) 
# 356 "wolfcrypt/src/signature.c"
                         || hash_len == 0 ||
        sig == 
# 357 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 357 "wolfcrypt/src/signature.c"
                   || sig_len == 
# 357 "wolfcrypt/src/signature.c" 3 4
                                 ((void *)0) 
# 357 "wolfcrypt/src/signature.c"
                                      || *sig_len == 0 ||
        key == 
# 358 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 358 "wolfcrypt/src/signature.c"
                   || key_len == 0) {
        return BAD_FUNC_ARG;
    }
    ...
    const void* key, word32 key_len, WC_RNG* rng, int verify)
{
    ...
    if (data == 
# 469 "wolfcrypt/src/signature.c" 3 4
               ((void *)0) 
# 469 "wolfcrypt/src/signature.c"
                    || data_len == 0 ||
        sig == 
# 470 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 470 "wolfcrypt/src/signature.c"
                   || sig_len == 
# 470 "wolfcrypt/src/signature.c" 3 4
                                 ((void *)0) 
# 470 "wolfcrypt/src/signature.c"
                                      || *sig_len == 0 ||
        key == 
# 471 "wolfcrypt/src/signature.c" 3 4
              ((void *)0) 
# 471 "wolfcrypt/src/signature.c"
                   || key_len == 0) {
        return BAD_FUNC_ARG;
    }
