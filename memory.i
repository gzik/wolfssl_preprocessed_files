# 1 "wolfcrypt/src/memory.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/memory.c"
# 24 "wolfcrypt/src/memory.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/memory.c" 2
...
# 28 "wolfcrypt/src/memory.c" 2
# 72 "wolfcrypt/src/memory.c"
...
# 60 "/usr/aarch64-linux-gnu/include/sys/types.h" 3
...
# 98 "/usr/aarch64-linux-gnu/include/sys/types.h" 3
...
# 75 "wolfcrypt/src/memory.c" 2
# 98 "wolfcrypt/src/memory.c"
static wolfSSL_Malloc_cb malloc_function = 
# 98 "wolfcrypt/src/memory.c" 3 4
                                           ((void *)0)
# 98 "wolfcrypt/src/memory.c"
                                               ;
static wolfSSL_Free_cb free_function = 
# 99 "wolfcrypt/src/memory.c" 3 4
                                         ((void *)0)
# 99 "wolfcrypt/src/memory.c"
                                             ;
static wolfSSL_Realloc_cb realloc_function = 
# 100 "wolfcrypt/src/memory.c" 3 4
                                            ((void *)0)
# 100 "wolfcrypt/src/memory.c"
                                                ;
...
static int create_memory_buckets(byte* buffer, word32 bufSz,
    ...
    for (i = 0; i < buckNum; i++) {
        if ((buckSz + memSz + padSz) <= (bufSz - ret)) {
            ...
            mem->next = 
# 270 "wolfcrypt/src/memory.c" 3 4
                       ((void *)0)
# 270 "wolfcrypt/src/memory.c"
                           ;


            if (*list == 
# 273 "wolfcrypt/src/memory.c" 3 4
                        ((void *)0)
# 273 "wolfcrypt/src/memory.c"
                            ) {
                *list = mem;
            } else {
                mem->next = *list;
...
{
    word32 wc_MemSz[9] = { 64,128,256,512,1024,2432,3456,4544, 16128 };
    word32 wc_Dist[9] = { 49,10,6,14,5,6,9,1,1 };

    if (heap == 
# 297 "wolfcrypt/src/memory.c" 3 4
               ((void *)0)
# 297 "wolfcrypt/src/memory.c"
                   ) {
        return BAD_FUNC_ARG;
    }

    memset((heap),(0),(sizeof(WOLFSSL_HEAP)));

    memcpy((heap->sizeList),(wc_MemSz),(sizeof(wc_MemSz)));
    memcpy((heap->distList),(wc_Dist),(sizeof(wc_Dist)));
    ...
    unsigned char* buf, unsigned int sz, int flag, int maxSz)
{
    ...
    if (pHint == 
# 322 "wolfcrypt/src/memory.c" 3 4
                ((void *)0) 
# 322 "wolfcrypt/src/memory.c"
                     || buf == 
# 322 "wolfcrypt/src/memory.c" 3 4
                               ((void *)0)
# 322 "wolfcrypt/src/memory.c"
    ...
    if (*pHint == 
# 331 "wolfcrypt/src/memory.c" 3 4
                 ((void *)0)
# 331 "wolfcrypt/src/memory.c"
                     ) {
        ...
        memset((hint),(0),(sizeof(WOLFSSL_HEAP_HINT)));
        hint->memory = heap;
    }
    else {
                                                             ...
                                                             WOLFSSL_HEAP* heap)
{
    ...
    if (buffer == 
# 390 "wolfcrypt/src/memory.c" 3 4
                 ((void *)0)
# 390 "wolfcrypt/src/memory.c"
                     ) {
        return BAD_FUNC_ARG;
    }


    while ((wolfssl_word)pt % 16 && pt < (buffer + sz)) {
        *pt = 0x00;
        pt++;
        ava--;
    }
...
{
    word32 bucketSz[9] = {64,128,256,512,1024,2432,3456,4544, 16128};
    word32 distList[9] = {49,10,6,14,5,6,9,1,1};
    ...
    if (buffer == 
# 473 "wolfcrypt/src/memory.c" 3 4
                 ((void *)0)
# 473 "wolfcrypt/src/memory.c"
                     ) {
        return BAD_FUNC_ARG;
    }
    ...
    if (flag & 0x02 || flag & 0x04) {
        if (ava < (memSz + padSz + 16992)) {
            return 0;
        }

        ava = ava % (memSz + padSz + 16992);
    }
    else {
        int i, k;
...
int FreeFixedIO(WOLFSSL_HEAP* heap, wc_Memory** io)
{
    ...
    if (*io == 
# 519 "wolfcrypt/src/memory.c" 3 4
              ((void *)0)
# 519 "wolfcrypt/src/memory.c"
                  ) {
        return 1;
    }

    if (heap == 
# 523 "wolfcrypt/src/memory.c" 3 4
               ((void *)0)
# 523 "wolfcrypt/src/memory.c"
                   ) {
        ;
    }
    else {
        ...
        heap->io = *io;
        *io = 
# 530 "wolfcrypt/src/memory.c" 3 4
                     ((void *)0)
# 530 "wolfcrypt/src/memory.c"
                         ;
    }
...
int SetFixedIO(WOLFSSL_HEAP* heap, wc_Memory** io)
{
    ;
    if (heap == 
# 540 "wolfcrypt/src/memory.c" 3 4
               ((void *)0)
# 540 "wolfcrypt/src/memory.c"
                   ) {
        return MEMORY_E;
    }
    ...
    *io = heap->io;
    ...
    if (*io != 
# 546 "wolfcrypt/src/memory.c" 3 4
              ((void *)0)
# 546 "wolfcrypt/src/memory.c"
                  ) {
        heap->io = (*io)->next;
        (*io)->next = 
# 548 "wolfcrypt/src/memory.c" 3 4
                     ((void *)0)
# 548 "wolfcrypt/src/memory.c"
                         ;
    }
    else {
        return 0;
...
int wolfSSL_GetMemStats(WOLFSSL_HEAP* heap, WOLFSSL_MEM_STATS* stats)
{
        ...
        memset((stats),(0),(sizeof(WOLFSSL_MEM_STATS)));
        ...
        for (i = 0; i < 9; i++) {
            ...
            for (pt = heap->ava[i]; pt != 
# 572 "wolfcrypt/src/memory.c" 3 4
                                         ((void *)0)
# 572 "wolfcrypt/src/memory.c"
                                             ; pt = pt->next) {
                stats->avaBlock[i] += 1;
            }
        }
        ...
        for (pt = heap->io; pt != 
# 577 "wolfcrypt/src/memory.c" 3 4
                                 ((void *)0)
# 577 "wolfcrypt/src/memory.c"
                                     ; pt = pt->next) {
            stats->avaIO++;
        }

        stats->flag = heap->flag;
...

{
    void* res = 0;
    wc_Memory* pt = 
# 594 "wolfcrypt/src/memory.c" 3 4
                   ((void *)0)
# 594 "wolfcrypt/src/memory.c"
                       ;
    int i;
# 605 "wolfcrypt/src/memory.c"
    if (heap == 
# 605 "wolfcrypt/src/memory.c" 3 4
               ((void *)0)
# 605 "wolfcrypt/src/memory.c"
                   ) {
# 622 "wolfcrypt/src/memory.c"
                res = malloc(size);
# 631 "wolfcrypt/src/memory.c"
    }
    else {
        ...
        if (wc_LockMutex(&(mem->memory_mutex)) != 0) {
            ;
            return 
# 638 "wolfcrypt/src/memory.c" 3 4
                  ((void *)0)
# 638 "wolfcrypt/src/memory.c"
                      ;
        }
        ...
        if (mem->flag & 0x04 &&
            ...
            if (mem->flag & 0x02 &&
                                             (type == DYNAMIC_TYPE_OUT_BUFFER ||
                                              type == DYNAMIC_TYPE_IN_BUFFER)) {
                if (mem->io != 
# 657 "wolfcrypt/src/memory.c" 3 4
                              ((void *)0)
# 657 "wolfcrypt/src/memory.c"
                                  ) {
                    pt = mem->io;
                    mem->io = pt->next;
                }
            ...
            if (pt == 
# 664 "wolfcrypt/src/memory.c" 3 4
                     ((void *)0)
# 664 "wolfcrypt/src/memory.c"
                         ) {
                for (i = 0; i < 9; i++) {
                    if ((word32)size < mem->sizeList[i]) {
                        if (mem->ava[i] != 
# 667 "wolfcrypt/src/memory.c" 3 4
                                          ((void *)0)
# 667 "wolfcrypt/src/memory.c"
                                              ) {
                            pt = mem->ava[i];
                            mem->ava[i] = pt->next;
                            break;
        ...
        if (pt != 
# 683 "wolfcrypt/src/memory.c" 3 4
                 ((void *)0)
# 683 "wolfcrypt/src/memory.c"
                     ) {
            mem->inUse += pt->sz;
            mem->alloc += 1;
            res = pt->buffer;
            ...
            if (mem->flag & 0x08) {
                ...
                if (stats != 
# 695 "wolfcrypt/src/memory.c" 3 4
                            ((void *)0)
# 695 "wolfcrypt/src/memory.c"
                                ) {
                    stats->curMem += pt->sz;
...

{
    ...
    if (ptr) {
        ...
        if (heap == 
# 751 "wolfcrypt/src/memory.c" 3 4
                   ((void *)0)
# 751 "wolfcrypt/src/memory.c"
                       ) {
# 766 "wolfcrypt/src/memory.c"
                free(ptr);
            ...
            WOLFSSL_HEAP_HINT* hint = (WOLFSSL_HEAP_HINT*)heap;
            WOLFSSL_HEAP* mem = hint->memory;
            word32 padSz = -(int)sizeof(wc_Memory) & (16 - 1);
            ...
            else if (mem->flag & 0x02 && pt->sz == 16992 &&
                                             (type == DYNAMIC_TYPE_OUT_BUFFER ||
                                              type == DYNAMIC_TYPE_IN_BUFFER)) {
                pt->next = mem->io;
                mem->io = pt;
            ...
            if (mem->flag & 0x08) {
                WOLFSSL_MEM_CONN_STATS* stats = hint->stats;
                if (stats != 
# 816 "wolfcrypt/src/memory.c" 3 4
                            ((void *)0)
# 816 "wolfcrypt/src/memory.c"
                                ) {
...

{
    void* res = 0;
    wc_Memory* pt = 
# 847 "wolfcrypt/src/memory.c" 3 4
                   ((void *)0)
# 847 "wolfcrypt/src/memory.c"
                       ;
    word32 prvSz;
    int i;
# 858 "wolfcrypt/src/memory.c"
    if (heap == 
# 858 "wolfcrypt/src/memory.c" 3 4
               ((void *)0)
# 858 "wolfcrypt/src/memory.c"
                   ) {
        ...
        if (ptr == 
# 873 "wolfcrypt/src/memory.c" 3 4
                  ((void *)0)
# 873 "wolfcrypt/src/memory.c"
                      ) {
        ...
        if (wc_LockMutex(&(mem->memory_mutex)) != 0) {
            ;
            return 
# 883 "wolfcrypt/src/memory.c" 3 4
                  ((void *)0)
# 883 "wolfcrypt/src/memory.c"
                      ;
        }


        if (((mem->flag & 0x02)||(mem->flag & 0x04))
                                          && (type == DYNAMIC_TYPE_OUT_BUFFER ||
                                              type == DYNAMIC_TYPE_IN_BUFFER)) {
            ...
            if (pt->sz < size) {
                ;
                res = 
# 894 "wolfcrypt/src/memory.c" 3 4
                     ((void *)0)
# 894 "wolfcrypt/src/memory.c"
                         ;
            }
            res = pt->buffer;
        }
            ...
            for (i = 0; i < 9; i++) {
                if ((word32)size < mem->sizeList[i]) {
                    if (mem->ava[i] != 
# 902 "wolfcrypt/src/memory.c" 3 4
                                      ((void *)0)
# 902 "wolfcrypt/src/memory.c"
                                          ) {
                        pt = mem->ava[i];
                        mem->ava[i] = pt->next;
                        break;
            ...
            if (pt != 
# 910 "wolfcrypt/src/memory.c" 3 4
                     ((void *)0) 
# 910 "wolfcrypt/src/memory.c"
                          && res == 
# 910 "wolfcrypt/src/memory.c" 3 4
                                    ((void *)0)
# 910 "wolfcrypt/src/memory.c"
                ...
                if (wc_LockMutex(&(mem->memory_mutex)) != 0) {
                    ;
                    return 
# 930 "wolfcrypt/src/memory.c" 3 4
                          ((void *)0)
# 930 "wolfcrypt/src/memory.c"
                              ;
                }
            }
        }
