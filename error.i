# 1 "wolfcrypt/src/error.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/error.c"
# 24 "wolfcrypt/src/error.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/error.c" 2
...
{
    strncpy((buffer),(wc_GetErrorString(error)),(80));
    buffer[80 -1] = 0;
}
