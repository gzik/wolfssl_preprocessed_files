...
# 1 "./config.h" 1
# 25 "wolfcrypt/src/hmac.c" 2


# 1 "./wolfssl/wolfcrypt/wc_port.h" 1
# 29 "./wolfssl/wolfcrypt/wc_port.h"
...
# 30 "./wolfssl/wolfcrypt/wc_port.h" 2
...
int wc_HmacSetKey(Hmac* hmac, int type, const byte* key, word32 length)
{
    ...
    int ret = 0;
    void* heap = 
# 103 "wolfcrypt/src/hmac.c" 3 4
                 ((void *)0)
# 103 "wolfcrypt/src/hmac.c"
                     ;

    if (hmac == 
# 105 "wolfcrypt/src/hmac.c" 3 4
               ((void *)0) 
# 105 "wolfcrypt/src/hmac.c"
                    || (key == 
# 105 "wolfcrypt/src/hmac.c" 3 4
                               ((void *)0) 
# 105 "wolfcrypt/src/hmac.c"
...
# 134 "wolfcrypt/src/hmac.c"
        ...
        case WC_SHA384:
            ...
            if (length <= WC_SHA384_BLOCK_SIZE) {
                if (key != 
# 155 "wolfcrypt/src/hmac.c" 3 4
                          ((void *)0)
# 155 "wolfcrypt/src/hmac.c"
                              ) {
                    memcpy((ip),(key),(length));
                }
            }
...
int wc_HmacUpdate(Hmac* hmac, const byte* msg, word32 length)
{
    ...
    if (hmac == 
# 222 "wolfcrypt/src/hmac.c" 3 4
               ((void *)0) 
# 222 "wolfcrypt/src/hmac.c"
                    || (msg == 
# 222 "wolfcrypt/src/hmac.c" 3 4
                               ((void *)0) 
# 222 "wolfcrypt/src/hmac.c"
...
int wc_HmacFinal(Hmac* hmac, byte* hash)
{
    ...
    if (hmac == 
# 257 "wolfcrypt/src/hmac.c" 3 4
               ((void *)0) 
# 257 "wolfcrypt/src/hmac.c"
                    || hash == 
# 257 "wolfcrypt/src/hmac.c" 3 4
                               ((void *)0)
# 257 "wolfcrypt/src/hmac.c"
...
int wc_HmacInit(Hmac* hmac, void* heap, int devId)
{
    ...
    if (hmac == 
# 319 "wolfcrypt/src/hmac.c" 3 4
               ((void *)0)
# 319 "wolfcrypt/src/hmac.c"
                   )
        return BAD_FUNC_ARG;
...
{
    if (hmac == 
# 334 "wolfcrypt/src/hmac.c" 3 4
               ((void *)0)
# 334 "wolfcrypt/src/hmac.c"
                   )
        return;
