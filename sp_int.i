...
# 40 "wolfcrypt/src/sp_int.c" 2
# 58 "wolfcrypt/src/sp_int.c"
...
# 59 "wolfcrypt/src/sp_int.c" 2
# 68 "wolfcrypt/src/sp_int.c"
int sp_init(sp_int* a)
{
    int err = 0;

    if (a == 
# 72 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 72 "wolfcrypt/src/sp_int.c"
                ) {
        err = -3;
    }
    if (err == 0) {
...
# 109 "wolfcrypt/src/sp_int.c"
int sp_init_multi(sp_int* n1, sp_int* n2, sp_int* n3, sp_int* n4, sp_int* n5,
                  sp_int* n6)
{
    if (n1 != 
# 112 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 112 "wolfcrypt/src/sp_int.c"
                 ) {
        n1->used = 0;
        n1->size = ((( 768 + 64) / 64) + 1);
    ...
    if (n2 != 
# 119 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 119 "wolfcrypt/src/sp_int.c"
                 ) {
        n2->used = 0;
        n2->size = ((( 768 + 64) / 64) + 1);
    ...
    if (n3 != 
# 126 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 126 "wolfcrypt/src/sp_int.c"
                 ) {
        n3->used = 0;
        n3->size = ((( 768 + 64) / 64) + 1);
    ...
    if (n4 != 
# 133 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 133 "wolfcrypt/src/sp_int.c"
                 ) {
        n4->used = 0;
        n4->size = ((( 768 + 64) / 64) + 1);
    ...
    if (n5 != 
# 140 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 140 "wolfcrypt/src/sp_int.c"
                 ) {
        n5->used = 0;
        n5->size = ((( 768 + 64) / 64) + 1);
    ...
    if (n6 != 
# 147 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 147 "wolfcrypt/src/sp_int.c"
                 ) {
        n6->used = 0;
        n6->size = ((( 768 + 64) / 64) + 1);
...
# 179 "wolfcrypt/src/sp_int.c"
int sp_grow(sp_int* a, int l)
{
    int err = 0;

    if (a == 
# 183 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 183 "wolfcrypt/src/sp_int.c"
                ) {
        err = -3;
    }
    if ((err == 0) && (l > a->size)) {
...
{
    if (a != 
# 223 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 223 "wolfcrypt/src/sp_int.c"
                ) {
        _sp_zero(a);
    }
}
...
{
    if (a != 
# 235 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 235 "wolfcrypt/src/sp_int.c"
                ) {
        int i;
...
# 274 "wolfcrypt/src/sp_int.c"
int sp_copy(sp_int* a, sp_int* r)
{
    int err = 0;

    if ((a == 
# 278 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 278 "wolfcrypt/src/sp_int.c"
                 ) || (r == 
# 278 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 278 "wolfcrypt/src/sp_int.c"
        ...
        memcpy((r->dp),(a->dp),(a->used * sizeof(sp_int_digit)));
        if (a->used == 0)
            r->dp[0] = 0;
        r->used = a->used;
...
static int _sp_cmp(sp_int* a, sp_int* b)
{
    int ret;
        ...
        ret = _sp_cmp_abs(a, b);
# 412 "wolfcrypt/src/sp_int.c"
    return ret;
}
# 427 "wolfcrypt/src/sp_int.c"
...
# 434 "wolfcrypt/src/sp_int.c" 3 4
                 ((void *)0)
# 434 "wolfcrypt/src/sp_int.c"
                     ) {
        ret = -1;
    }
    else if (b == 
# 437 "wolfcrypt/src/sp_int.c" 3 4
                 ((void *)0)
# 437 "wolfcrypt/src/sp_int.c"
                     ) {
        ret = 1;
    }
    else
...
# 456 "wolfcrypt/src/sp_int.c"
int sp_count_bits(sp_int* a)
{
    int r = 0;

    if (a != 
# 460 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 460 "wolfcrypt/src/sp_int.c"
                ) {
        r = a->used - 1;
        while ((r >= 0) && (a->dp[r] == 0)) {
            r--;
...
# 503 "wolfcrypt/src/sp_int.c"
int sp_leading_bit(sp_int* a)
{
    int bit = 0;

    if ((a != 
# 507 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 507 "wolfcrypt/src/sp_int.c"
                 ) && (a->used > 0)) {
...
int sp_set_bit(sp_int* a, int i)
{
    ...
    if ((a == 
# 538 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 538 "wolfcrypt/src/sp_int.c"
                 ) || (w >= a->size)) {
        err = -3;
    }
    else {
...
# 571 "wolfcrypt/src/sp_int.c"
int sp_set(sp_int* a, sp_int_digit d)
{
    int err = 0;

    if (a == 
# 575 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 575 "wolfcrypt/src/sp_int.c"
                ) {
        err = -3;
    }
    if (err == 0) {
...
# 601 "wolfcrypt/src/sp_int.c"
int sp_cmp_d(sp_int* a, sp_int_digit d)
{
    int ret = 0;

    if (a == 
# 605 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 605 "wolfcrypt/src/sp_int.c"
                ) {
        ret = -1;
    }
    else
...
static void _sp_sub_d(sp_int* a, sp_int_digit d, sp_int* r)
{
    ...
    if (a->used == 0) {
        ...
        if (t > a->dp[0]) {
            for (++i; i < a->used; i++) {
                r->dp[i] = a->dp[i] - 1;
                if (r->dp[i] != 0xffffffffffffffffUL) {
                   break;
                }
            }
        }
...
# 694 "wolfcrypt/src/sp_int.c"
int sp_sub_d(sp_int* a, sp_int_digit d, sp_int* r)
{
    int err = 0;

    if ((a == 
# 698 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 698 "wolfcrypt/src/sp_int.c"
                 ) || (r == 
# 698 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 698 "wolfcrypt/src/sp_int.c"
        ...
        _sp_sub_d(a, d, r);
# 719 "wolfcrypt/src/sp_int.c"
    }

    return err;
}
# 739 "wolfcrypt/src/sp_int.c"
...
# 776 "wolfcrypt/src/sp_int.c"
static inline sp_int_digit sp_div_word(sp_int_digit hi, sp_int_digit lo,
                                          sp_int_digit d)
{
# 816 "wolfcrypt/src/sp_int.c"
    sp_int_word w;
    sp_int_digit r;

    w = ((sp_int_word)hi << 64) | lo;
    w /= d;
    r = (sp_int_digit)w;
...
static int _sp_add_off(sp_int* a, sp_int* b, sp_int* r, int o)
{
    ...
    if (0) {
        do { int ii; fprintf(
# 888 "wolfcrypt/src/sp_int.c" 3
       stderr
# 888 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "a"); for (ii = (a)->used-1; ii >= 0; ii--) { fprintf(
# 888 "wolfcrypt/src/sp_int.c" 3
       stderr
# 888 "wolfcrypt/src/sp_int.c"
       , "%016lx", (a)->dp[ii]); } fprintf(
# 888 "wolfcrypt/src/sp_int.c" 3
       stderr
# 888 "wolfcrypt/src/sp_int.c"
       , "\n"); } while (0);
        do { int ii; fprintf(
# 889 "wolfcrypt/src/sp_int.c" 3
       stderr
# 889 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "b"); for (ii = (b)->used-1; ii >= 0; ii--) { fprintf(
# 889 "wolfcrypt/src/sp_int.c" 3
       stderr
# 889 "wolfcrypt/src/sp_int.c"
       , "%016lx", (b)->dp[ii]); } fprintf(
# 889 "wolfcrypt/src/sp_int.c" 3
       stderr
# 889 "wolfcrypt/src/sp_int.c"
       , "\n"); } while (0);
    }
# 900 "wolfcrypt/src/sp_int.c"
    i = 0;
    (void)o;
    ...
    if (0) {
        do { int ii; fprintf(
# 929 "wolfcrypt/src/sp_int.c" 3
       stderr
# 929 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "radd"); for (ii = (r)->used-1; ii >= 0; ii--) { fprintf(
# 929 "wolfcrypt/src/sp_int.c" 3
       stderr
# 929 "wolfcrypt/src/sp_int.c"
       , "%016lx", (r)->dp[ii]); } fprintf(
# 929 "wolfcrypt/src/sp_int.c" 3
       stderr
# 929 "wolfcrypt/src/sp_int.c"
       , "\n"); } while (0);
...
# 987 "wolfcrypt/src/sp_int.c"
int sp_add(sp_int* a, sp_int* b, sp_int* r)
{
    int err = 0;

    if ((a == 
# 991 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 991 "wolfcrypt/src/sp_int.c"
                 ) || (b == 
# 991 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 991 "wolfcrypt/src/sp_int.c"
...
# 1011 "wolfcrypt/src/sp_int.c"
    }

    return err;
}
# 1030 "wolfcrypt/src/sp_int.c"
int sp_sub(sp_int* a, sp_int* b, sp_int* r)
{
    int err = 0;

    if ((a == 
# 1034 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1034 "wolfcrypt/src/sp_int.c"
                 ) || (b == 
# 1034 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 1034 "wolfcrypt/src/sp_int.c"
...
# 1054 "wolfcrypt/src/sp_int.c"
    }

    return err;
}
# 1075 "wolfcrypt/src/sp_int.c"
int sp_lshd(sp_int* a, int s)
{
    int err = 0;

    if (a == 
# 1079 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 1079 "wolfcrypt/src/sp_int.c"
                ) {
        err = -3;
    }
    if ((err == 0) && (a->used + s > a->size)) {
        err = -3;
    }
    if (err == 0) {
        memmove((a->dp + s),(a->dp),(a->used * sizeof(sp_int_digit)));
        a->used += s;
        memset((a->dp),(0),(s * sizeof(sp_int_digit)));
        do { int ii; for (ii = a->used - 1; ii >= 0 && a->dp[ii] == 0; ii--) { } a->used = ii + 1; } while (0);
    }

    return err;
}
# 1106 "wolfcrypt/src/sp_int.c"
static int sp_lshb(sp_int* a, int n)
{
    if (a->used != 0) {
        ...
        if (n != 0) {
            ...
            v = a->dp[a->used - 1] >> (64 - n);
            a->dp[a->used - 1 + s] = a->dp[a->used - 1] << n;
            for (i = a->used - 2; i >= 0; i--) {
                a->dp[i + 1 + s] |= a->dp[i] >> (64 - n);
                a->dp[i + s] = a->dp[i] << n;
            }
            if (v != 0) {
                a->dp[a->used + s] = v;
        ...
        a->used += s;
        memset((a->dp),(0),((64 / 8) * s));
    }

    return 0;
}
# 1149 "wolfcrypt/src/sp_int.c"
void sp_rshd(sp_int* a, int c)
{
    if (a != 
# 1151 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 1151 "wolfcrypt/src/sp_int.c"
                ) {
        int i;
        int j;
...
int sp_div(sp_int* a, sp_int* d, sp_int* r, sp_int* rem)
{
    ...
    int c;
# 1256 "wolfcrypt/src/sp_int.c"
    if ((a == 
# 1256 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1256 "wolfcrypt/src/sp_int.c"
                 ) || (d == 
# 1256 "wolfcrypt/src/sp_int.c" 3 4
...
# 1256 "wolfcrypt/src/sp_int.c"
    ...
    if (0 && (err == 0)) {
        do { int ii; fprintf(
# 1264 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1264 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "a"); for (ii = (a)->used-1; ii >= 0; ii--) { fprintf(
# 1264 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1264 "wolfcrypt/src/sp_int.c"
...
# 1264 "wolfcrypt/src/sp_int.c"
       , "\n"); } while (0);
        do { int ii; fprintf(
# 1265 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1265 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "b"); for (ii = (d)->used-1; ii >= 0; ii--) { fprintf(
# 1265 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1265 "wolfcrypt/src/sp_int.c"
       , "%016lx", (d)->dp[ii]); } fprintf(
# 1265 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1265 "wolfcrypt/src/sp_int.c"
       , "\n"); } while (0);
    ...
    if (err == 0) {
        ...
        if (ret == -1) {
            if (rem != 
# 1276 "wolfcrypt/src/sp_int.c" 3 4
                      ((void *)0)
# 1276 "wolfcrypt/src/sp_int.c"
                          ) {
                sp_copy(a, rem);
            }
            if (r != 
# 1279 "wolfcrypt/src/sp_int.c" 3 4
                    ((void *)0)
# 1279 "wolfcrypt/src/sp_int.c"
                        ) {
                sp_set(r, 0);
            }
            done = 1;
            ...
            if (rem != 
# 1285 "wolfcrypt/src/sp_int.c" 3 4
                      ((void *)0)
# 1285 "wolfcrypt/src/sp_int.c"
                          ) {
                sp_set(rem, 0);
            }
            if (r != 
# 1288 "wolfcrypt/src/sp_int.c" 3 4
                    ((void *)0)
# 1288 "wolfcrypt/src/sp_int.c"
                        ) {
                sp_set(r, 1);
            ...
            if (rem != 
# 1298 "wolfcrypt/src/sp_int.c" 3 4
                      ((void *)0)
# 1298 "wolfcrypt/src/sp_int.c"
                          ) {
                _sp_sub_off(a, d, rem, 0);
            }
            if (r != 
# 1301 "wolfcrypt/src/sp_int.c" 3 4
                    ((void *)0)
# 1301 "wolfcrypt/src/sp_int.c"
                        ) {
                sp_set(r, 1);
    ...
    if ((!done) && (err == 0) && (d->used > 0)) {
        ...
        if (sa->dp[sa->used - d->used + i] >= d->dp[i]) {
            ...
            sa->used = i;
            if (r != 
# 1348 "wolfcrypt/src/sp_int.c" 3 4
                    ((void *)0)
# 1348 "wolfcrypt/src/sp_int.c"
                        ) {
        ...
        if (rem != 
# 1377 "wolfcrypt/src/sp_int.c" 3 4
                  ((void *)0)
# 1377 "wolfcrypt/src/sp_int.c"
                      ) {
            ...
            sp_copy(sa, rem);
            do { int ii; for (ii = rem->used - 1; ii >= 0 && rem->dp[ii] == 0; ii--) { } rem->used = ii + 1; } while (0);
        }
        if (r != 
# 1387 "wolfcrypt/src/sp_int.c" 3 4
                ((void *)0)
# 1387 "wolfcrypt/src/sp_int.c"
                    ) {
            sp_copy(tr, r);
            do { int ii; for (ii = r->used - 1; ii >= 0 && r->dp[ii] == 0; ii--) { } r->used = ii + 1; } while (0);
    ...
    if (0 && (err == 0)) {
        if (rem != 
# 1397 "wolfcrypt/src/sp_int.c" 3 4
                  ((void *)0)
# 1397 "wolfcrypt/src/sp_int.c"
                      ) {
            do { int ii; fprintf(
# 1398 "wolfcrypt/src/sp_int.c" 3
           stderr
# 1398 "wolfcrypt/src/sp_int.c"
           , "%s=0x0", "rdr"); for (ii = (rem)->used-1; ii >= 0; ii--) { fprintf(
# 1398 "wolfcrypt/src/sp_int.c" 3
           stderr
# 1398 "wolfcrypt/src/sp_int.c"
           , "%016lx", (rem)->dp[ii]); } fprintf(
# 1398 "wolfcrypt/src/sp_int.c" 3
           stderr
# 1398 "wolfcrypt/src/sp_int.c"
           , "\n"); } while (0);
        ...
        if (r != 
# 1400 "wolfcrypt/src/sp_int.c" 3 4
                ((void *)0)
# 1400 "wolfcrypt/src/sp_int.c"
                    ) {
            do { int ii; fprintf(
# 1401 "wolfcrypt/src/sp_int.c" 3
           stderr
# 1401 "wolfcrypt/src/sp_int.c"
           , "%s=0x0", "rdw"); for (ii = (r)->used-1; ii >= 0; ii--) { fprintf(
# 1401 "wolfcrypt/src/sp_int.c" 3
           stderr
# 1401 "wolfcrypt/src/sp_int.c"
           , "%016lx", (r)->dp[ii]); } fprintf(
...
int sp_mod(sp_int* a, sp_int* m, sp_int* r)
{
    ...
    if ((a == 
# 1429 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1429 "wolfcrypt/src/sp_int.c"
                 ) || (m == 
# 1429 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 1429 "wolfcrypt/src/sp_int.c"
...
# 1429 "wolfcrypt/src/sp_int.c"
    ...
    if (err == 0) {
        err = sp_div(a, m, 
# 1435 "wolfcrypt/src/sp_int.c" 3 4
                          ((void *)0)
# 1435 "wolfcrypt/src/sp_int.c"
                              , r);
    }
# 1454 "wolfcrypt/src/sp_int.c"
    return err;
}
# 1479 "wolfcrypt/src/sp_int.c"
...
int sp_mul(sp_int* a, sp_int* b, sp_int* r)
{
    ...
    if ((a == 
# 1542 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1542 "wolfcrypt/src/sp_int.c"
                 ) || (b == 
# 1542 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 1542 "wolfcrypt/src/sp_int.c"
...
# 1542 "wolfcrypt/src/sp_int.c"
    ...
    if ((err == 0) && (a->used + b->used >= r->size)) {
        err = -3;
    }

    if (0 && (err == 0)) {
        do { int ii; fprintf(
# 1552 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1552 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "a"); for (ii = (a)->used-1; ii >= 0; ii--) { fprintf(
# 1552 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1552 "wolfcrypt/src/sp_int.c"
...
# 1552 "wolfcrypt/src/sp_int.c"
       , "\n"); } while (0);
        do { int ii; fprintf(
# 1553 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1553 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "b"); for (ii = (b)->used-1; ii >= 0; ii--) { fprintf(
# 1553 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1553 "wolfcrypt/src/sp_int.c"
...
# 1553 "wolfcrypt/src/sp_int.c"
    ...
    if (0 && (err == 0)) {
        do { int ii; fprintf(
# 1583 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1583 "wolfcrypt/src/sp_int.c"
       , "%s=0x0", "rmul"); for (ii = (r)->used-1; ii >= 0; ii--) { fprintf(
# 1583 "wolfcrypt/src/sp_int.c" 3
       stderr
# 1583 "wolfcrypt/src/sp_int.c"
       , "%016lx", (r)->dp[ii]); } fprintf(
...
int sp_mulmod(sp_int* a, sp_int* b, sp_int* m, sp_int* r)
{
    ...
    if ((a == 
# 1608 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1608 "wolfcrypt/src/sp_int.c"
                 ) || (b == 
# 1608 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 1608 "wolfcrypt/src/sp_int.c"
...
int sp_invmod(sp_int* a, sp_int* m, sp_int* r)
{
    ...
    if ((a == 
# 1651 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1651 "wolfcrypt/src/sp_int.c"
                 ) || (m == 
# 1651 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 1651 "wolfcrypt/src/sp_int.c"
...
# 1651 "wolfcrypt/src/sp_int.c"
    ...
    if (err == 0) {
        ...
        if (_sp_cmp_abs(a, m) != -1) {
            err = sp_mod(a, m, v);
            a = v;
        }
    }
# 1679 "wolfcrypt/src/sp_int.c"
    if ((err == 0) && (((a)->used == 0) || ((m)->used == 0))) {
        err = -3;
    }

    if ((err == 0) && (((a)->used != 0) && (((a)->dp[0] & 1) == 0)) && (((m)->used != 0) && (((m)->dp[0] & 1) == 0))) {
        err = -3;
    }


    if ((err == 0) && (((a)->used == 1) && ((a)->dp[0] == 1))) {
        sp_set(r, 1);
    }
    else if (err != 0) {
    }
    else if ((((m)->used != 0) && (((m)->dp[0] & 1) == 0))) {
        ...
        if (err == 0) {
            _sp_sub_d(r, 1, r);
            sp_div(r, a, r, 
# 1703 "wolfcrypt/src/sp_int.c" 3 4
                           ((void *)0)
# 1703 "wolfcrypt/src/sp_int.c"
                               );
            sp_sub(m, r, r);
        }
    }
        ...
        while (!(((v)->used == 1) && ((v)->dp[0] == 1)) && !((u)->used == 0)) {
            if ((((u)->used != 0) && (((u)->dp[0] & 1) == 0))) {
                sp_div_2(u, u);
                if ((((b)->used != 0) && ((b)->dp[0] & 1))) {
                    sp_add(b, m, b);
                }
                sp_div_2(b, b);
            }
            else if ((((v)->used != 0) && (((v)->dp[0] & 1) == 0))) {
                sp_div_2(v, v);
                if ((((c)->used != 0) && ((c)->dp[0] & 1))) {
                    sp_add(c, m, c);
                }
                sp_div_2(c, c);
            }
            else if (_sp_cmp(u, v) != -1) {
                sp_sub(u, v, u);
                if (_sp_cmp(b, c) == -1) {
                    sp_add(b, m, b);
                }
...
# 1772 "wolfcrypt/src/sp_int.c"
int sp_sqr(sp_int* a, sp_int* r)
{
    return sp_mul(a, a, r);
}
# 1793 "wolfcrypt/src/sp_int.c"
int sp_sqrmod(sp_int* a, sp_int* m, sp_int* r)
{
    int err = 0;

    if ((a == 
# 1797 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1797 "wolfcrypt/src/sp_int.c"
                 ) || (m == 
# 1797 "wolfcrypt/src/sp_int.c" 3 4
                            ((void *)0)
# 1797 "wolfcrypt/src/sp_int.c"
...
# 1829 "wolfcrypt/src/sp_int.c"
int sp_unsigned_bin_size(sp_int* a)
{
    int cnt = 0;

    if (a != 
# 1833 "wolfcrypt/src/sp_int.c" 3 4
            ((void *)0)
# 1833 "wolfcrypt/src/sp_int.c"
                ) {
...
# 1850 "wolfcrypt/src/sp_int.c"
int sp_read_unsigned_bin(sp_int* a, const byte* in, word32 inSz)
{
    int err = 0;

    if ((a == 
# 1854 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 1854 "wolfcrypt/src/sp_int.c"
                 ) || ((in == 
# 1854 "wolfcrypt/src/sp_int.c" 3 4
                              ((void *)0)
# 1854 "wolfcrypt/src/sp_int.c"
    ...
    if ((err == 0) && (inSz > ((word32)a->size - 1) * (64 / 8))) {
        err = -3;
    }
    ...
    if (err == 0) {
        ...
        a->used = (inSz + (64 / 8) - 1) / (64 / 8);

        for (i = inSz-1, j = 0; i >= (64 / 8) - 1; i -= (64 / 8)) {
        ...
        if (i >= 0) {
            ...
            a->dp[a->used - 1] = 0;
            switch (i) {
                case 6: d[inSz - 1 - 6] = in[6]; __attribute__ ((fallthrough));;
                case 5: d[inSz - 1 - 5] = in[5]; __attribute__ ((fallthrough));;
                case 4: d[inSz - 1 - 4] = in[4]; __attribute__ ((fallthrough));;
                case 3: d[inSz - 1 - 3] = in[3]; __attribute__ ((fallthrough));;
                case 2: d[inSz - 1 - 2] = in[2]; __attribute__ ((fallthrough));;
                case 1: d[inSz - 1 - 1] = in[1]; __attribute__ ((fallthrough));;
...
# 2060 "wolfcrypt/src/sp_int.c"
int sp_read_radix(sp_int* a, const char* in, int radix)
{
    int err = 0;

    if ((a == 
# 2064 "wolfcrypt/src/sp_int.c" 3 4
             ((void *)0)
# 2064 "wolfcrypt/src/sp_int.c"
                 ) || (in == 
# 2064 "wolfcrypt/src/sp_int.c" 3 4
                             ((void *)0)
# 2064 "wolfcrypt/src/sp_int.c"
