# 1 "wolfcrypt/src/sha512.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/sha512.c"
# 24 "wolfcrypt/src/sha512.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/sha512.c" 2
...
# 28 "wolfcrypt/src/sha512.c" 2



# 1 "./wolfssl/wolfcrypt/sha512.h" 1
# 30 "./wolfssl/wolfcrypt/sha512.h"
...
# 31 "./wolfssl/wolfcrypt/sha512.h" 2
...
__attribute__ ((visibility("default"))) int wc_InitSha384(wc_Sha384*);
__attribute__ ((visibility("default"))) int wc_InitSha384_ex(wc_Sha384*, void*, int);
__attribute__ ((visibility("default"))) int wc_Sha384Update(wc_Sha384*, const byte*, word32);
__attribute__ ((visibility("default"))) int wc_Sha384FinalRaw(wc_Sha384*, byte*);
__attribute__ ((visibility("default"))) int wc_Sha384Final(wc_Sha384*, byte*);
__attribute__ ((visibility("default"))) void wc_Sha384Free(wc_Sha384*);

__attribute__ ((visibility("default"))) int wc_Sha384GetHash(wc_Sha384*, byte*);
__attribute__ ((visibility("default"))) int wc_Sha384Copy(wc_Sha384* src, wc_Sha384* dst);
# 32 "wolfcrypt/src/sha512.c" 2
...
# 33 "wolfcrypt/src/sha512.c" 2
# 1 "./wolfssl/wolfcrypt/cpuid.h" 1
# 34 "wolfcrypt/src/sha512.c" 2
# 1 "./wolfssl/wolfcrypt/hash.h" 1
# 38 "./wolfssl/wolfcrypt/hash.h"
...
__attribute__ ((visibility("default"))) int wc_HashGetOID(enum wc_HashType hash_type);
__attribute__ ((visibility("default"))) enum wc_HashType wc_OidGetHash(int oid);


__attribute__ ((visibility("default"))) enum wc_HashType wc_HashTypeConvert(int hashType);

__attribute__ ((visibility("default"))) int wc_HashGetDigestSize(enum wc_HashType hash_type);
__attribute__ ((visibility("default"))) int wc_HashGetBlockSize(enum wc_HashType hash_type);
__attribute__ ((visibility("default"))) int wc_Hash(enum wc_HashType hash_type,
    const byte* data, word32 data_len,
    byte* hash, word32 hash_len);


__attribute__ ((visibility("default"))) int wc_HashInit_ex(wc_HashAlg* hash, enum wc_HashType type,
    void* heap, int devId);
__attribute__ ((visibility("default"))) int wc_HashInit(wc_HashAlg* hash, enum wc_HashType type);
__attribute__ ((visibility("default"))) int wc_HashUpdate(wc_HashAlg* hash, enum wc_HashType type,
    const byte* data, word32 dataSz);
__attribute__ ((visibility("default"))) int wc_HashFinal(wc_HashAlg* hash, enum wc_HashType type,
    byte* out);
__attribute__ ((visibility("default"))) int wc_HashFree(wc_HashAlg* hash, enum wc_HashType type);
# 194 "./wolfssl/wolfcrypt/hash.h"
__attribute__ ((visibility("default"))) int wc_Sha256Hash(const byte*, word32, byte*);




__attribute__ ((visibility("default"))) int wc_Sha384Hash(const byte*, word32, byte*);
...
static int _Transform_Sha512(wc_Sha512* sha512)
{
    ...
    for (j = 0; j < 80; j += 16) {
        T[(7-0) & 7] += (rotrFixed64(T[(4-0) & 7],14) ^ rotrFixed64(T[(4-0) & 7],18) ^ rotrFixed64(T[(4-0) & 7],41)) + (T[(6-0) & 7] ^ (T[(4-0) & 7] & (T[(5-0) & 7] ^ T[(6-0) & 7]))) + K[0 +j] + (j ? ( W[ 0 & 15] += (rotrFixed64(W[(0 -2) & 15],19) ^ rotrFixed64(W[(0 -2) & 15],61) ^ (W[(0 -2) & 15]>>6))+ W[(0 -7) & 15] + (rotrFixed64(W[(0 -15) & 15],1) ^ rotrFixed64(W[(0 -15) & 15],8) ^ (W[(0 -15) & 15]>>7)) ) : (W[0] = sha512->buffer[0])); T[(3-0) & 7] += T[(7-0) & 7]; T[(7-0) & 7] += (rotrFixed64(T[(0-0) & 7],28) ^ rotrFixed64(T[(0-0) & 7],34) ^ rotrFixed64(T[(0-0) & 7],39)) + ((T[(0-0) & 7] & T[(1-0) & 7]) | (T[(2-0) & 7] & (T[(0-0) & 7] | T[(1-0) & 7]))); T[(7-1) & 7] += (rotrFixed64(T[(4-1) & 7],14) ^ rotrFixed64(T[(4-1) & 7],18) ^ rotrFixed64(T[(4-1) & 7],41)) + (T[(6-1) & 7] ^ (T[(4-1) & 7] & (T[(5-1) & 7] ^ T[(6-1) & 7]))) + K[1 +j] + (j ? ( W[ 1 & 15] += (rotrFixed64(W[(1 -2) & 15],19) ^ rotrFixed64(W[(1 -2) & 15],61) ^ (W[(1 -2) & 15]>>6))+ W[(1 -7) & 15] + (rotrFixed64(W[(1 -15) & 15],1) ^ rotrFixed64(W[(1 -15) & 15],8) ^ (W[(1 -15) & 15]>>7)) ) : (W[1] = sha512->buffer[1])); T[(3-1) & 7] += T[(7-1) & 7]; T[(7-1) & 7] += (rotrFixed64(T[(0-1) & 7],28) ^ rotrFixed64(T[(0-1) & 7],34) ^ rotrFixed64(T[(0-1) & 7],39)) + ((T[(0-1) & 7] & T[(1-1) & 7]) | (T[(2-1) & 7] & (T[(0-1) & 7] | T[(1-1) & 7]))); T[(7-2) & 7] += (rotrFixed64(T[(4-2) & 7],14) ^ rotrFixed64(T[(4-2) & 7],18) ^ rotrFixed64(T[(4-2) & 7],41)) + (T[(6-2) & 7] ^ (T[(4-2) & 7] & (T[(5-2) & 7] ^ T[(6-2) & 7]))) + K[2 +j] + (j ? ( W[ 2 & 15] += (rotrFixed64(W[(2 -2) & 15],19) ^ rotrFixed64(W[(2 -2) & 15],61) ^ (W[(2 -2) & 15]>>6))+ W[(2 -7) & 15] + (rotrFixed64(W[(2 -15) & 15],1) ^ rotrFixed64(W[(2 -15) & 15],8) ^ (W[(2 -15) & 15]>>7)) ) : (W[2] = sha512->buffer[2])); T[(3-2) & 7] += T[(7-2) & 7]; T[(7-2) & 7] += (rotrFixed64(T[(0-2) & 7],28) ^ rotrFixed64(T[(0-2) & 7],34) ^ rotrFixed64(T[(0-2) & 7],39)) + ((T[(0-2) & 7] & T[(1-2) & 7]) | (T[(2-2) & 7] & (T[(0-2) & 7] | T[(1-2) & 7]))); T[(7-3) & 7] += (rotrFixed64(T[(4-3) & 7],14) ^ rotrFixed64(T[(4-3) & 7],18) ^ rotrFixed64(T[(4-3) & 7],41)) + (T[(6-3) & 7] ^ (T[(4-3) & 7] & (T[(5-3) & 7] ^ T[(6-3) & 7]))) + K[3 +j] + (j ? ( W[ 3 & 15] += (rotrFixed64(W[(3 -2) & 15],19) ^ rotrFixed64(W[(3 -2) & 15],61) ^ (W[(3 -2) & 15]>>6))+ W[(3 -7) & 15] + (rotrFixed64(W[(3 -15) & 15],1) ^ rotrFixed64(W[(3 -15) & 15],8) ^ (W[(3 -15) & 15]>>7)) ) : (W[3] = sha512->buffer[3])); T[(3-3) & 7] += T[(7-3) & 7]; T[(7-3) & 7] += (rotrFixed64(T[(0-3) & 7],28) ^ rotrFixed64(T[(0-3) & 7],34) ^ rotrFixed64(T[(0-3) & 7],39)) + ((T[(0-3) & 7] & T[(1-3) & 7]) | (T[(2-3) & 7] & (T[(0-3) & 7] | T[(1-3) & 7])));
        T[(7-4) & 7] += (rotrFixed64(T[(4-4) & 7],14) ^ rotrFixed64(T[(4-4) & 7],18) ^ rotrFixed64(T[(4-4) & 7],41)) + (T[(6-4) & 7] ^ (T[(4-4) & 7] & (T[(5-4) & 7] ^ T[(6-4) & 7]))) + K[4 +j] + (j ? ( W[ 4 & 15] += (rotrFixed64(W[(4 -2) & 15],19) ^ rotrFixed64(W[(4 -2) & 15],61) ^ (W[(4 -2) & 15]>>6))+ W[(4 -7) & 15] + (rotrFixed64(W[(4 -15) & 15],1) ^ rotrFixed64(W[(4 -15) & 15],8) ^ (W[(4 -15) & 15]>>7)) ) : (W[4] = sha512->buffer[4])); T[(3-4) & 7] += T[(7-4) & 7]; T[(7-4) & 7] += (rotrFixed64(T[(0-4) & 7],28) ^ rotrFixed64(T[(0-4) & 7],34) ^ rotrFixed64(T[(0-4) & 7],39)) + ((T[(0-4) & 7] & T[(1-4) & 7]) | (T[(2-4) & 7] & (T[(0-4) & 7] | T[(1-4) & 7]))); T[(7-5) & 7] += (rotrFixed64(T[(4-5) & 7],14) ^ rotrFixed64(T[(4-5) & 7],18) ^ rotrFixed64(T[(4-5) & 7],41)) + (T[(6-5) & 7] ^ (T[(4-5) & 7] & (T[(5-5) & 7] ^ T[(6-5) & 7]))) + K[5 +j] + (j ? ( W[ 5 & 15] += (rotrFixed64(W[(5 -2) & 15],19) ^ rotrFixed64(W[(5 -2) & 15],61) ^ (W[(5 -2) & 15]>>6))+ W[(5 -7) & 15] + (rotrFixed64(W[(5 -15) & 15],1) ^ rotrFixed64(W[(5 -15) & 15],8) ^ (W[(5 -15) & 15]>>7)) ) : (W[5] = sha512->buffer[5])); T[(3-5) & 7] += T[(7-5) & 7]; T[(7-5) & 7] += (rotrFixed64(T[(0-5) & 7],28) ^ rotrFixed64(T[(0-5) & 7],34) ^ rotrFixed64(T[(0-5) & 7],39)) + ((T[(0-5) & 7] & T[(1-5) & 7]) | (T[(2-5) & 7] & (T[(0-5) & 7] | T[(1-5) & 7]))); T[(7-6) & 7] += (rotrFixed64(T[(4-6) & 7],14) ^ rotrFixed64(T[(4-6) & 7],18) ^ rotrFixed64(T[(4-6) & 7],41)) + (T[(6-6) & 7] ^ (T[(4-6) & 7] & (T[(5-6) & 7] ^ T[(6-6) & 7]))) + K[6 +j] + (j ? ( W[ 6 & 15] += (rotrFixed64(W[(6 -2) & 15],19) ^ rotrFixed64(W[(6 -2) & 15],61) ^ (W[(6 -2) & 15]>>6))+ W[(6 -7) & 15] + (rotrFixed64(W[(6 -15) & 15],1) ^ rotrFixed64(W[(6 -15) & 15],8) ^ (W[(6 -15) & 15]>>7)) ) : (W[6] = sha512->buffer[6])); T[(3-6) & 7] += T[(7-6) & 7]; T[(7-6) & 7] += (rotrFixed64(T[(0-6) & 7],28) ^ rotrFixed64(T[(0-6) & 7],34) ^ rotrFixed64(T[(0-6) & 7],39)) + ((T[(0-6) & 7] & T[(1-6) & 7]) | (T[(2-6) & 7] & (T[(0-6) & 7] | T[(1-6) & 7]))); T[(7-7) & 7] += (rotrFixed64(T[(4-7) & 7],14) ^ rotrFixed64(T[(4-7) & 7],18) ^ rotrFixed64(T[(4-7) & 7],41)) + (T[(6-7) & 7] ^ (T[(4-7) & 7] & (T[(5-7) & 7] ^ T[(6-7) & 7]))) + K[7 +j] + (j ? ( W[ 7 & 15] += (rotrFixed64(W[(7 -2) & 15],19) ^ rotrFixed64(W[(7 -2) & 15],61) ^ (W[(7 -2) & 15]>>6))+ W[(7 -7) & 15] + (rotrFixed64(W[(7 -15) & 15],1) ^ rotrFixed64(W[(7 -15) & 15],8) ^ (W[(7 -15) & 15]>>7)) ) : (W[7] = sha512->buffer[7])); T[(3-7) & 7] += T[(7-7) & 7]; T[(7-7) & 7] += (rotrFixed64(T[(0-7) & 7],28) ^ rotrFixed64(T[(0-7) & 7],34) ^ rotrFixed64(T[(0-7) & 7],39)) + ((T[(0-7) & 7] & T[(1-7) & 7]) | (T[(2-7) & 7] & (T[(0-7) & 7] | T[(1-7) & 7])));
        T[(7-8) & 7] += (rotrFixed64(T[(4-8) & 7],14) ^ rotrFixed64(T[(4-8) & 7],18) ^ rotrFixed64(T[(4-8) & 7],41)) + (T[(6-8) & 7] ^ (T[(4-8) & 7] & (T[(5-8) & 7] ^ T[(6-8) & 7]))) + K[8 +j] + (j ? ( W[ 8 & 15] += (rotrFixed64(W[(8 -2) & 15],19) ^ rotrFixed64(W[(8 -2) & 15],61) ^ (W[(8 -2) & 15]>>6))+ W[(8 -7) & 15] + (rotrFixed64(W[(8 -15) & 15],1) ^ rotrFixed64(W[(8 -15) & 15],8) ^ (W[(8 -15) & 15]>>7)) ) : (W[8] = sha512->buffer[8])); T[(3-8) & 7] += T[(7-8) & 7]; T[(7-8) & 7] += (rotrFixed64(T[(0-8) & 7],28) ^ rotrFixed64(T[(0-8) & 7],34) ^ rotrFixed64(T[(0-8) & 7],39)) + ((T[(0-8) & 7] & T[(1-8) & 7]) | (T[(2-8) & 7] & (T[(0-8) & 7] | T[(1-8) & 7]))); T[(7-9) & 7] += (rotrFixed64(T[(4-9) & 7],14) ^ rotrFixed64(T[(4-9) & 7],18) ^ rotrFixed64(T[(4-9) & 7],41)) + (T[(6-9) & 7] ^ (T[(4-9) & 7] & (T[(5-9) & 7] ^ T[(6-9) & 7]))) + K[9 +j] + (j ? ( W[ 9 & 15] += (rotrFixed64(W[(9 -2) & 15],19) ^ rotrFixed64(W[(9 -2) & 15],61) ^ (W[(9 -2) & 15]>>6))+ W[(9 -7) & 15] + (rotrFixed64(W[(9 -15) & 15],1) ^ rotrFixed64(W[(9 -15) & 15],8) ^ (W[(9 -15) & 15]>>7)) ) : (W[9] = sha512->buffer[9])); T[(3-9) & 7] += T[(7-9) & 7]; T[(7-9) & 7] += (rotrFixed64(T[(0-9) & 7],28) ^ rotrFixed64(T[(0-9) & 7],34) ^ rotrFixed64(T[(0-9) & 7],39)) + ((T[(0-9) & 7] & T[(1-9) & 7]) | (T[(2-9) & 7] & (T[(0-9) & 7] | T[(1-9) & 7]))); T[(7-10) & 7] += (rotrFixed64(T[(4-10) & 7],14) ^ rotrFixed64(T[(4-10) & 7],18) ^ rotrFixed64(T[(4-10) & 7],41)) + (T[(6-10) & 7] ^ (T[(4-10) & 7] & (T[(5-10) & 7] ^ T[(6-10) & 7]))) + K[10 +j] + (j ? ( W[ 10 & 15] += (rotrFixed64(W[(10 -2) & 15],19) ^ rotrFixed64(W[(10 -2) & 15],61) ^ (W[(10 -2) & 15]>>6))+ W[(10 -7) & 15] + (rotrFixed64(W[(10 -15) & 15],1) ^ rotrFixed64(W[(10 -15) & 15],8) ^ (W[(10 -15) & 15]>>7)) ) : (W[10] = sha512->buffer[10])); T[(3-10) & 7] += T[(7-10) & 7]; T[(7-10) & 7] += (rotrFixed64(T[(0-10) & 7],28) ^ rotrFixed64(T[(0-10) & 7],34) ^ rotrFixed64(T[(0-10) & 7],39)) + ((T[(0-10) & 7] & T[(1-10) & 7]) | (T[(2-10) & 7] & (T[(0-10) & 7] | T[(1-10) & 7]))); T[(7-11) & 7] += (rotrFixed64(T[(4-11) & 7],14) ^ rotrFixed64(T[(4-11) & 7],18) ^ rotrFixed64(T[(4-11) & 7],41)) + (T[(6-11) & 7] ^ (T[(4-11) & 7] & (T[(5-11) & 7] ^ T[(6-11) & 7]))) + K[11 +j] + (j ? ( W[ 11 & 15] += (rotrFixed64(W[(11 -2) & 15],19) ^ rotrFixed64(W[(11 -2) & 15],61) ^ (W[(11 -2) & 15]>>6))+ W[(11 -7) & 15] + (rotrFixed64(W[(11 -15) & 15],1) ^ rotrFixed64(W[(11 -15) & 15],8) ^ (W[(11 -15) & 15]>>7)) ) : (W[11] = sha512->buffer[11])); T[(3-11) & 7] += T[(7-11) & 7]; T[(7-11) & 7] += (rotrFixed64(T[(0-11) & 7],28) ^ rotrFixed64(T[(0-11) & 7],34) ^ rotrFixed64(T[(0-11) & 7],39)) + ((T[(0-11) & 7] & T[(1-11) & 7]) | (T[(2-11) & 7] & (T[(0-11) & 7] | T[(1-11) & 7])));
        T[(7-12) & 7] += (rotrFixed64(T[(4-12) & 7],14) ^ rotrFixed64(T[(4-12) & 7],18) ^ rotrFixed64(T[(4-12) & 7],41)) + (T[(6-12) & 7] ^ (T[(4-12) & 7] & (T[(5-12) & 7] ^ T[(6-12) & 7]))) + K[12 +j] + (j ? ( W[ 12 & 15] += (rotrFixed64(W[(12 -2) & 15],19) ^ rotrFixed64(W[(12 -2) & 15],61) ^ (W[(12 -2) & 15]>>6))+ W[(12 -7) & 15] + (rotrFixed64(W[(12 -15) & 15],1) ^ rotrFixed64(W[(12 -15) & 15],8) ^ (W[(12 -15) & 15]>>7)) ) : (W[12] = sha512->buffer[12])); T[(3-12) & 7] += T[(7-12) & 7]; T[(7-12) & 7] += (rotrFixed64(T[(0-12) & 7],28) ^ rotrFixed64(T[(0-12) & 7],34) ^ rotrFixed64(T[(0-12) & 7],39)) + ((T[(0-12) & 7] & T[(1-12) & 7]) | (T[(2-12) & 7] & (T[(0-12) & 7] | T[(1-12) & 7]))); T[(7-13) & 7] += (rotrFixed64(T[(4-13) & 7],14) ^ rotrFixed64(T[(4-13) & 7],18) ^ rotrFixed64(T[(4-13) & 7],41)) + (T[(6-13) & 7] ^ (T[(4-13) & 7] & (T[(5-13) & 7] ^ T[(6-13) & 7]))) + K[13 +j] + (j ? ( W[ 13 & 15] += (rotrFixed64(W[(13 -2) & 15],19) ^ rotrFixed64(W[(13 -2) & 15],61) ^ (W[(13 -2) & 15]>>6))+ W[(13 -7) & 15] + (rotrFixed64(W[(13 -15) & 15],1) ^ rotrFixed64(W[(13 -15) & 15],8) ^ (W[(13 -15) & 15]>>7)) ) : (W[13] = sha512->buffer[13])); T[(3-13) & 7] += T[(7-13) & 7]; T[(7-13) & 7] += (rotrFixed64(T[(0-13) & 7],28) ^ rotrFixed64(T[(0-13) & 7],34) ^ rotrFixed64(T[(0-13) & 7],39)) + ((T[(0-13) & 7] & T[(1-13) & 7]) | (T[(2-13) & 7] & (T[(0-13) & 7] | T[(1-13) & 7]))); T[(7-14) & 7] += (rotrFixed64(T[(4-14) & 7],14) ^ rotrFixed64(T[(4-14) & 7],18) ^ rotrFixed64(T[(4-14) & 7],41)) + (T[(6-14) & 7] ^ (T[(4-14) & 7] & (T[(5-14) & 7] ^ T[(6-14) & 7]))) + K[14 +j] + (j ? ( W[ 14 & 15] += (rotrFixed64(W[(14 -2) & 15],19) ^ rotrFixed64(W[(14 -2) & 15],61) ^ (W[(14 -2) & 15]>>6))+ W[(14 -7) & 15] + (rotrFixed64(W[(14 -15) & 15],1) ^ rotrFixed64(W[(14 -15) & 15],8) ^ (W[(14 -15) & 15]>>7)) ) : (W[14] = sha512->buffer[14])); T[(3-14) & 7] += T[(7-14) & 7]; T[(7-14) & 7] += (rotrFixed64(T[(0-14) & 7],28) ^ rotrFixed64(T[(0-14) & 7],34) ^ rotrFixed64(T[(0-14) & 7],39)) + ((T[(0-14) & 7] & T[(1-14) & 7]) | (T[(2-14) & 7] & (T[(0-14) & 7] | T[(1-14) & 7]))); T[(7-15) & 7] += (rotrFixed64(T[(4-15) & 7],14) ^ rotrFixed64(T[(4-15) & 7],18) ^ rotrFixed64(T[(4-15) & 7],41)) + (T[(6-15) & 7] ^ (T[(4-15) & 7] & (T[(5-15) & 7] ^ T[(6-15) & 7]))) + K[15 +j] + (j ? ( W[ 15 & 15] += (rotrFixed64(W[(15 -2) & 15],19) ^ rotrFixed64(W[(15 -2) & 15],61) ^ (W[(15 -2) & 15]>>6))+ W[(15 -7) & 15] + (rotrFixed64(W[(15 -15) & 15],1) ^ rotrFixed64(W[(15 -15) & 15],8) ^ (W[(15 -15) & 15]>>7)) ) : (W[15] = sha512->buffer[15])); T[(3-15) & 7] += T[(7-15) & 7]; T[(7-15) & 7] += (rotrFixed64(T[(0-15) & 7],28) ^ rotrFixed64(T[(0-15) & 7],34) ^ rotrFixed64(T[(0-15) & 7],39)) + ((T[(0-15) & 7] & T[(1-15) & 7]) | (T[(2-15) & 7] & (T[(0-15) & 7] | T[(1-15) & 7])));
    }


    sha512->digest[0] += T[(0-0) & 7];
    sha512->digest[1] += T[(1-0) & 7];
    sha512->digest[2] += T[(2-0) & 7];
    sha512->digest[3] += T[(3-0) & 7];
    sha512->digest[4] += T[(4-0) & 7];
    sha512->digest[5] += T[(5-0) & 7];
    sha512->digest[6] += T[(6-0) & 7];
    sha512->digest[7] += T[(7-0) & 7];
...
# 215 "wolfcrypt/src/sha512.c"
    {
        while (len >= WC_SHA512_BLOCK_SIZE) {
            memcpy((local),(data),(WC_SHA512_BLOCK_SIZE));
...
static inline int Sha512Final(wc_Sha512* sha512)
{
    ...
    if (sha512 == 
# 243 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0)
# 243 "wolfcrypt/src/sha512.c"
                     ) {
        return BAD_FUNC_ARG;
    }
    ...
    if (sha512->buffLen > WC_SHA512_PAD_SIZE) {
        memset((&local[sha512->buffLen]),(0),(WC_SHA512_BLOCK_SIZE - sha512->buffLen));
    ...
    memset((&local[sha512->buffLen]),(0),(WC_SHA512_PAD_SIZE - sha512->buffLen));
...
{
    if (sha384 == 
# 298 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0)
# 298 "wolfcrypt/src/sha512.c"
                     ) {
        return BAD_FUNC_ARG;
    }

    sha384->digest[0] = 0xcbbb9d5dc1059ed8LL;
    sha384->digest[1] = 0x629a292a367cd507LL;
    sha384->digest[2] = 0x9159015a3070dd17LL;
    sha384->digest[3] = 0x152fecd8f70e5939LL;
    sha384->digest[4] = 0x67332667ffc00b31LL;
    sha384->digest[5] = 0x8eb44a8768581511LL;
    sha384->digest[6] = 0xdb0c2e0d64f98fa7LL;
    sha384->digest[7] = 0x47b5481dbefa4fa4LL;
...
{
    if (sha384 == 
# 320 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0) 
# 320 "wolfcrypt/src/sha512.c"
                      || (data == 
# 320 "wolfcrypt/src/sha512.c" 3 4
                                  ((void *)0) 
# 320 "wolfcrypt/src/sha512.c"
...
int wc_Sha384FinalRaw(wc_Sha384* sha384, byte* hash)
{
    ...
    if (sha384 == 
# 333 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0) 
# 333 "wolfcrypt/src/sha512.c"
                      || hash == 
# 333 "wolfcrypt/src/sha512.c" 3 4
                                 ((void *)0)
# 333 "wolfcrypt/src/sha512.c"
    ...
    memcpy((hash),(digest),(WC_SHA384_DIGEST_SIZE));
...
int wc_Sha384Final(wc_Sha384* sha384, byte* hash)
{
    ...
    if (sha384 == 
# 352 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0) 
# 352 "wolfcrypt/src/sha512.c"
                      || hash == 
# 352 "wolfcrypt/src/sha512.c" 3 4
                                 ((void *)0)
# 352 "wolfcrypt/src/sha512.c"
    ...
    memcpy((hash),(sha384->digest),(WC_SHA384_DIGEST_SIZE));
...
int wc_InitSha384_ex(wc_Sha384* sha384, void* heap, int devId)
{
    ...
    if (sha384 == 
# 369 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0)
# 369 "wolfcrypt/src/sha512.c"
                     ) {
        return BAD_FUNC_ARG;
    }
...
{
    return wc_InitSha384_ex(sha384, 
# 385 "wolfcrypt/src/sha512.c" 3 4
                                   ((void *)0)
# 385 "wolfcrypt/src/sha512.c"
                                       , -2);
}
...
{
    if (sha384 == 
# 390 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0)
# 390 "wolfcrypt/src/sha512.c"
                     )
        return;
}
...
int wc_Sha384GetHash(wc_Sha384* sha384, byte* hash)
{
    ...
    if (sha384 == 
# 403 "wolfcrypt/src/sha512.c" 3 4
                 ((void *)0) 
# 403 "wolfcrypt/src/sha512.c"
                      || hash == 
# 403 "wolfcrypt/src/sha512.c" 3 4
                                 ((void *)0)
# 403 "wolfcrypt/src/sha512.c"
...
int wc_Sha384Copy(wc_Sha384* src, wc_Sha384* dst)
{
    ...
    if (src == 
# 416 "wolfcrypt/src/sha512.c" 3 4
              ((void *)0) 
# 416 "wolfcrypt/src/sha512.c"
                   || dst == 
# 416 "wolfcrypt/src/sha512.c" 3 4
                             ((void *)0)
# 416 "wolfcrypt/src/sha512.c"
    ...
    memcpy((dst),(src),(sizeof(wc_Sha384)));
