# 1 "wolfcrypt/src/asn.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/asn.c"
# 31 "wolfcrypt/src/asn.c"
# 1 "./config.h" 1
# 32 "wolfcrypt/src/asn.c" 2
...
# 35 "wolfcrypt/src/asn.c" 2
# 43 "wolfcrypt/src/asn.c"
# 1 "./wolfssl/wolfcrypt/asn.h" 1
# 37 "./wolfssl/wolfcrypt/asn.h"
...
__attribute__ ((visibility("default"))) int wc_HmacSetKey(Hmac*, int type, const byte* key, word32 keySz);
__attribute__ ((visibility("default"))) int wc_HmacUpdate(Hmac*, const byte*, word32);
__attribute__ ((visibility("default"))) int wc_HmacFinal(Hmac*, byte*);
__attribute__ ((visibility("default"))) int wc_HmacSizeByType(int type);

__attribute__ ((visibility("default"))) int wc_HmacInit(Hmac* hmac, void* heap, int devId);
...
__attribute__ ((visibility("default"))) void wc_HmacFree(Hmac*);

__attribute__ ((visibility("default"))) int wolfSSL_GetHmacMaxSize(void);

__attribute__ ((visibility("hidden"))) int _InitHmac(Hmac* hmac, int type, void* heap);
# 45 "wolfcrypt/src/asn.c" 2
...
# 55 "wolfcrypt/src/asn.c" 2
# 66 "wolfcrypt/src/asn.c"
...
# 134 "wolfcrypt/src/asn.c"
int GetASNTag(const byte* input, word32* inOutIdx, byte* tag, word32 maxIdx)
{
    word32 idx;

    if (tag == 
# 138 "wolfcrypt/src/asn.c" 3 4
              ((void *)0) 
# 138 "wolfcrypt/src/asn.c"
                   || inOutIdx == 
# 138 "wolfcrypt/src/asn.c" 3 4
                                  ((void *)0) 
# 138 "wolfcrypt/src/asn.c"
...
static int SetASNIntMP(mp_int* n, int maxSz, byte* output)
{
    ...
    leadingBit = sp_leading_bit(n);
    length = sp_unsigned_bin_size(n);
    ...
    if (output) {
        err = sp_to_unsigned_bin(n, output + idx);
        if (err != 0)
            return MP_TO_E;
    }
    idx += length;
...
int SetASNInt(int len, byte firstByte, byte* output)
{
    ...
    if (firstByte & 0x80)
        len++;
    idx += SetLength(len, output ? output + idx : 
# 380 "wolfcrypt/src/asn.c" 3 4
                                                 ((void *)0)
# 380 "wolfcrypt/src/asn.c"
                                                     );
    if (firstByte & 0x80) {
        if (output)
            output[idx] = 0x00;
...
int GetInt(mp_int* mpi, const byte* input, word32* inOutIdx, word32 maxIdx)
{
    ...
    if (sp_read_unsigned_bin(mpi, (byte*)input + idx, length) != 0) {
        sp_clear(mpi);
        return ASN_GETINT_E;
    }
                          ...
                          word32 maxIdx, int zeroBits, byte* unusedBits)
{
    ...
    *inOutIdx = idx;
    if (len != 
# 481 "wolfcrypt/src/asn.c" 3 4
              ((void *)0)
# 481 "wolfcrypt/src/asn.c"
                  )
        *len = length;
    if (unusedBits != 
# 483 "wolfcrypt/src/asn.c" 3 4
                     ((void *)0)
# 483 "wolfcrypt/src/asn.c"
                         )
        *unusedBits = b;

    return 0;
}
# 499 "wolfcrypt/src/asn.c"
                        ...
                        byte* pFormat, int* pLength, word32 maxIdx)
{
    ...
    if (source == 
# 571 "wolfcrypt/src/asn.c" 3 4
                 ((void *)0) 
# 571 "wolfcrypt/src/asn.c"
                      || idx == 
# 571 "wolfcrypt/src/asn.c" 3 4
                                ((void *)0)
# 571 "wolfcrypt/src/asn.c"
...
word32 SetSequence(word32 len, byte* output)
{
    ...
    return SetLength(len, output ? output + 1 : 
# 651 "wolfcrypt/src/asn.c" 3 4
                                               ((void *)0)
# 651 "wolfcrypt/src/asn.c"
                                                   ) + 1;
}
    ...
    byte* serial, int* serialSz, word32 maxIdx)
{
    ...
    if (serial == 
# 700 "wolfcrypt/src/asn.c" 3 4
                 ((void *)0) 
# 700 "wolfcrypt/src/asn.c"
                      || input == 
# 700 "wolfcrypt/src/asn.c" 3 4
                                  ((void *)0) 
# 700 "wolfcrypt/src/asn.c"
...
# 700 "wolfcrypt/src/asn.c"
    ...
    memcpy((serial),(&input[*inOutIdx]),(*serialSz));
    *inOutIdx += *serialSz;
    ...
    static int CheckCurve(word32 oid)
    {
        ...
        ret = wc_ecc_get_oid(oid, 
# 735 "wolfcrypt/src/asn.c" 3 4
                                 ((void *)0)
# 735 "wolfcrypt/src/asn.c"
                                     , &oidSz);
        if (ret < 0 || oidSz == 0) {
            ;
            ret = ALGO_ID_E;
...
int StoreECC_DSA_Sig(byte* out, word32* outLen, mp_int* r, mp_int* s)
{
    ...
    int rLeadingZero = sp_leading_bit(r);
    int sLeadingZero = sp_leading_bit(s);
    int rLen = sp_unsigned_bin_size(r);
    int sLen = sp_unsigned_bin_size(s);
    ...
    const byte* s, word32 sLen)
{
    ...
    if ((out == 
# 817 "wolfcrypt/src/asn.c" 3 4
               ((void *)0)
# 817 "wolfcrypt/src/asn.c"
                   ) || (outLen == 
# 817 "wolfcrypt/src/asn.c" 3 4
                                   ((void *)0)
# 817 "wolfcrypt/src/asn.c"
                        ...
                        word32 inSz)
{
    ...
    byte* pubData = 
# 946 "wolfcrypt/src/asn.c" 3 4
                   ((void *)0)
# 946 "wolfcrypt/src/asn.c"
                       ;

    if (input == 
# 948 "wolfcrypt/src/asn.c" 3 4
                ((void *)0) 
# 948 "wolfcrypt/src/asn.c"
                     || inOutIdx == 
# 948 "wolfcrypt/src/asn.c" 3 4
                                    ((void *)0) 
# 948 "wolfcrypt/src/asn.c"
    ...
    if (ret == 0 && (*inOutIdx + 1) < inSz) {
        ...
        *inOutIdx += 1;
        ...
        if (b != ECC_PREFIX_1) {
            ...
            ret = CheckBitString(input, inOutIdx, &length, inSz, 0, 
# 1014 "wolfcrypt/src/asn.c" 3 4
                                                                   ((void *)0)
# 1014 "wolfcrypt/src/asn.c"
                                                                       );
            if (ret == 0) {
                          ...
                          ecc_key* key, word32 inSz)
{
    ...
    if (input == 
# 1046 "wolfcrypt/src/asn.c" 3 4
                ((void *)0) 
# 1046 "wolfcrypt/src/asn.c"
                     || inOutIdx == 
# 1046 "wolfcrypt/src/asn.c" 3 4
                                    ((void *)0) 
# 1046 "wolfcrypt/src/asn.c"
...
# 1046 "wolfcrypt/src/asn.c"
    ...
    ret = CheckBitString(input, inOutIdx, &length, inSz, 1, 
# 1127 "wolfcrypt/src/asn.c" 3 4
                                                           ((void *)0)
# 1127 "wolfcrypt/src/asn.c"
                                                               );
    if (ret != 0)
        return ret;
