# 1 "wolfcrypt/src/wolfmath.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/wolfmath.c"
# 26 "wolfcrypt/src/wolfmath.c"
# 1 "./config.h" 1
# 27 "wolfcrypt/src/wolfmath.c" 2
...
# 31 "wolfcrypt/src/wolfmath.c" 2

# 1 "./wolfssl/wolfcrypt/integer.h" 1
# 35 "./wolfssl/wolfcrypt/integer.h"
...
# 36 "./wolfssl/wolfcrypt/integer.h" 2
...
# 36 "wolfcrypt/src/wolfmath.c" 2
# 47 "wolfcrypt/src/wolfmath.c"
...
# 48 "wolfcrypt/src/wolfmath.c" 2
# 57 "wolfcrypt/src/wolfmath.c"
    const wolfssl_word wc_off_on_addr[2] =
    {

        0x0000000000000000LL,
        0xffffffffffffffffLL
# 70 "wolfcrypt/src/wolfmath.c"
    };
...
{
    if (a == 
# 76 "wolfcrypt/src/wolfmath.c" 3 4
            ((void *)0)
# 76 "wolfcrypt/src/wolfmath.c"
                )
        return 0;
...
{
    if (a == 
# 84 "wolfcrypt/src/wolfmath.c" 3 4
            ((void *)0)
# 84 "wolfcrypt/src/wolfmath.c"
                )
        return 0;

    return (n >= a->used || n < 0) ? 0 : a->dp[n];
}
# 98 "wolfcrypt/src/wolfmath.c"
int mp_cond_copy(mp_int* a, int copy, mp_int* b)
{
    ...
    if (a == 
# 104 "wolfcrypt/src/wolfmath.c" 3 4
            ((void *)0) 
# 104 "wolfcrypt/src/wolfmath.c"
                 || b == 
# 104 "wolfcrypt/src/wolfmath.c" 3 4
                         ((void *)0)
# 104 "wolfcrypt/src/wolfmath.c"
...
int mp_rand(mp_int* a, int digits, WC_RNG* rng)
{
    ...
    if (rng == 
# 144 "wolfcrypt/src/wolfmath.c" 3 4
              ((void *)0)
# 144 "wolfcrypt/src/wolfmath.c"
                  ) {
        ret = MISSING_RNG_E;
    }
    else if (a == 
# 147 "wolfcrypt/src/wolfmath.c" 3 4
                 ((void *)0) 
# 147 "wolfcrypt/src/wolfmath.c"
                      || digits == 0) {
        ret = BAD_FUNC_ARG;
    }
# 158 "wolfcrypt/src/wolfmath.c"
    if ((ret == 0) && (digits > ((( 768 + 64) / 64) + 1)))
    ...
    int encType)
{
    ...
    if (mp == 
# 202 "wolfcrypt/src/wolfmath.c" 3 4
             ((void *)0)
# 202 "wolfcrypt/src/wolfmath.c"
                 )
        return BAD_FUNC_ARG;
    ...
    *len = keySz;
    ...
    if (encType == WC_TYPE_HEX_STR) {
        ...
        err = sp_to_unsigned_bin(mp, buf + (keySz - sp_unsigned_bin_size(mp)));
    }
