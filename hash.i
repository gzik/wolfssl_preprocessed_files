# 1 "wolfcrypt/src/hash.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/hash.c"
# 24 "wolfcrypt/src/hash.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/hash.c" 2
...
# 28 "wolfcrypt/src/hash.c" 2
# 1 "./wolfssl/wolfcrypt/logging.h" 1
# 33 "./wolfssl/wolfcrypt/logging.h"
...
# 34 "./wolfssl/wolfcrypt/logging.h" 2
...
# 36 "wolfcrypt/src/hash.c" 2
# 1 "./wolfssl/wolfcrypt/cryptocb.h" 1
# 37 "wolfcrypt/src/hash.c" 2
    ...
    int devId)
{
    ...
    if (hash == 
# 548 "wolfcrypt/src/hash.c" 3 4
               ((void *)0)
# 548 "wolfcrypt/src/hash.c"
                   )
        return BAD_FUNC_ARG;
...
{
    return wc_HashInit_ex(hash, type, 
# 620 "wolfcrypt/src/hash.c" 3 4
                                     ((void *)0)
# 620 "wolfcrypt/src/hash.c"
                                         , -2);
}
                  ...
                  word32 dataSz)
{
    ...
    if (hash == 
# 628 "wolfcrypt/src/hash.c" 3 4
               ((void *)0) 
# 628 "wolfcrypt/src/hash.c"
                    || (data == 
# 628 "wolfcrypt/src/hash.c" 3 4
                                ((void *)0) 
# 628 "wolfcrypt/src/hash.c"
...
int wc_HashFinal(wc_HashAlg* hash, enum wc_HashType type, byte* out)
{
    ...
    if (hash == 
# 702 "wolfcrypt/src/hash.c" 3 4
               ((void *)0) 
# 702 "wolfcrypt/src/hash.c"
                    || out == 
# 702 "wolfcrypt/src/hash.c" 3 4
                              ((void *)0)
# 702 "wolfcrypt/src/hash.c"
...
int wc_HashFree(wc_HashAlg* hash, enum wc_HashType type)
{
    ...
    if (hash == 
# 776 "wolfcrypt/src/hash.c" 3 4
               ((void *)0)
# 776 "wolfcrypt/src/hash.c"
                   )
        return BAD_FUNC_ARG;
...
# 1104 "wolfcrypt/src/hash.c"
    int wc_Sha256Hash(const byte* data, word32 len, byte* hash)
    {
        ...
        int devId = -2;
# 1127 "wolfcrypt/src/hash.c"
        if ((ret = wc_InitSha256_ex(sha256, 
# 1127 "wolfcrypt/src/hash.c" 3 4
                                           ((void *)0)
# 1127 "wolfcrypt/src/hash.c"
                                               , devId)) != 0) {
            ;
