# 1 "wolfcrypt/src/cmac.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/aarch64-linux-gnu/include/stdc-predef.h" 1 3
# 1 "<command-line>" 2
# 1 "wolfcrypt/src/cmac.c"
# 24 "wolfcrypt/src/cmac.c"
# 1 "./config.h" 1
# 25 "wolfcrypt/src/cmac.c" 2
                ...
                int type, void* unused)
{
    ...
    if (cmac == 
# 70 "wolfcrypt/src/cmac.c" 3 4
               ((void *)0) 
# 70 "wolfcrypt/src/cmac.c"
                    || key == 
# 70 "wolfcrypt/src/cmac.c" 3 4
                              ((void *)0) 
# 70 "wolfcrypt/src/cmac.c"
                                   || keySz == 0 || type != WC_CMAC_AES)
        return BAD_FUNC_ARG;

    memset((cmac),(0),(sizeof(Cmac)));
    ret = wc_AesSetKey(&cmac->aes, key, keySz, 
# 74 "wolfcrypt/src/cmac.c" 3 4
                                              ((void *)0)
# 74 "wolfcrypt/src/cmac.c"
                                                  , AES_ENCRYPTION);
    if (ret == 0) {
...
int wc_CmacFinal(Cmac* cmac, byte* out, word32* outSz)
{
    ...
    if (cmac == 
# 120 "wolfcrypt/src/cmac.c" 3 4
               ((void *)0) 
# 120 "wolfcrypt/src/cmac.c"
                    || out == 
# 120 "wolfcrypt/src/cmac.c" 3 4
                              ((void *)0) 
# 120 "wolfcrypt/src/cmac.c"
...
# 120 "wolfcrypt/src/cmac.c"
    ...
    if (*outSz < (AES_BLOCK_SIZE/4) || *outSz > AES_BLOCK_SIZE)
        return BUFFER_E;
                       ...
                       const byte* key, word32 keySz)
{
    ...
    if (out == 
# 159 "wolfcrypt/src/cmac.c" 3 4
              ((void *)0) 
# 159 "wolfcrypt/src/cmac.c"
                   || (in == 
# 159 "wolfcrypt/src/cmac.c" 3 4
                             ((void *)0) 
# 159 "wolfcrypt/src/cmac.c"
...
# 159 "wolfcrypt/src/cmac.c"
    ...
    ret = wc_InitCmac(&cmac, key, keySz, WC_CMAC_AES, 
# 162 "wolfcrypt/src/cmac.c" 3 4
                                                     ((void *)0)
# 162 "wolfcrypt/src/cmac.c"
                                                         );
    if (ret != 0)
        return ret;
                     ...
                     const byte* key, word32 keySz)
{
    ...
    if (check == 
# 187 "wolfcrypt/src/cmac.c" 3 4
                ((void *)0) 
# 187 "wolfcrypt/src/cmac.c"
                     || checkSz == 0 || (in == 
# 187 "wolfcrypt/src/cmac.c" 3 4
                                               ((void *)0) 
# 187 "wolfcrypt/src/cmac.c"
                                                    && inSz != 0) ||
        key == 
# 188 "wolfcrypt/src/cmac.c" 3 4
              ((void *)0) 
# 188 "wolfcrypt/src/cmac.c"
                   || keySz == 0)
